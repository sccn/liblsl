...
public:
    ...
    is_less_than(const lslboost::serialization::extended_type_info &rhs) const BOOST_OVERRIDE;
    BOOST_SERIALIZATION_DECL bool
    is_equal(const lslboost::serialization::extended_type_info &rhs) const BOOST_OVERRIDE;
};

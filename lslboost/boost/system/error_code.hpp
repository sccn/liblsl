...
protected:
    ...
    explicit BOOST_SYSTEM_CONSTEXPR error_category( lslboost::ulong_long_type id ) BOOST_NOEXCEPT: id_( id )
    {
    }
...
public:
    ...
    BOOST_SYSTEM_CONSTEXPR generic_error_category() BOOST_NOEXCEPT:
        error_category( ( lslboost::ulong_long_type( 0xB2AB117A ) << 32 ) + 0x257EDF0D )
    {
    }
...
public:
    ...
    BOOST_SYSTEM_CONSTEXPR system_error_category() BOOST_NOEXCEPT:
        error_category( ( lslboost::ulong_long_type( 0x8FAFD21E ) << 32 ) + 0x25C5E09B )
    {
    }
...
inline std::size_t hash_value( error_code const & ec )
{
    ...
    lslboost::ulong_long_type id = cat.id_;

    if( id == 0 )
    {
        id = reinterpret_cast<lslboost::ulong_long_type>( &cat );
    }

    lslboost::ulong_long_type hv = ( lslboost::ulong_long_type( 0xCBF29CE4 ) << 32 ) + 0x84222325;
    lslboost::ulong_long_type const prime = ( lslboost::ulong_long_type( 0x00000100 ) << 32 ) + 0x000001B3;
...
inline std::string lslboost::system::detail::generic_error_category::message( int ev ) const
{
    return generic_error_category_message( ev );
}

inline char const * lslboost::system::detail::generic_error_category::message( int ev, char * buffer, std::size_t len ) const BOOST_NOEXCEPT
{
...
inline lslboost::system::error_condition lslboost::system::detail::system_error_category::default_error_condition( int ev ) const BOOST_NOEXCEPT
{
    return system_category_default_error_condition_win32( ev );
}

inline std::string lslboost::system::detail::system_error_category::message( int ev ) const
{
    return system_category_message_win32( ev );
}

inline char const * lslboost::system::detail::system_error_category::message( int ev, char * buffer, std::size_t len ) const BOOST_NOEXCEPT
{
...
inline lslboost::system::error_category::operator std::error_category const & () const
{
    return lslboost::system::detail::to_std_category( *this );
}

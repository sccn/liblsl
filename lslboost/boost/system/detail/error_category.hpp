...
static const lslboost::ulong_long_type generic_category_id = ( lslboost::ulong_long_type( 0xB2AB117A ) << 32 ) + 0x257EDF0D;
static const lslboost::ulong_long_type system_category_id = ( lslboost::ulong_long_type( 0x8FAFD21E ) << 32 ) + 0x25C5E09B;

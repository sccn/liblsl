...
namespace lslboost { namespace parameter { 
    ...
    struct value_type0
    {
        ...
        using type = ::lslboost::mp11::mp_apply_q<
          ...
          , ::lslboost::mp11::mp_list<Keyword,Default,::lslboost::mp11::mp_false>
        >;
...
namespace lslboost { namespace parameter { 
    ...
    struct value_type
      ...
      : ::lslboost::mpl::eval_if<
          ...
          , ::lslboost::parameter::value_type0<Parameters,Keyword,Default>
        >
#endif
    {
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using type = typename ::lslboost::mp11::mp_if<
          ...
          , ::lslboost::mp11::mp_if<
              ...
              , ::lslboost::parameter::value_type1<Parameters,Keyword,Default>
              , ::lslboost::parameter::value_type0<Parameters,Keyword,Default>
            >
        >::type;
#endif

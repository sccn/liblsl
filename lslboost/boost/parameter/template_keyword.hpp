...
namespace lslboost { namespace parameter { 
    ...
    struct template_keyword : ::lslboost::parameter::aux::template_keyword_base
    {
...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using reference = typename ::lslboost::mp11::mp_eval_if<
            ::lslboost::mp11::mp_if<
        ...
        typedef typename ::lslboost::mpl::eval_if<
            typename ::lslboost::mpl::if_<
                ::lslboost::is_function<value_type>
              , ::lslboost::mpl::true_
              , ::lslboost::is_array<value_type>
            >::type
          , ::lslboost::add_lvalue_reference<value_type>
          , ::lslboost::mpl::identity<value_type>
        >::type reference;
...
#define BOOST_PARAMETER_TEMPLATE_KEYWORD(name)                               \
    ...
    template <typename T>                                                    \
    struct name : ::lslboost::parameter::template_keyword<tag::name,T>          \
    {                                                                        \
    };
/**/

...
//         , ... lslboost::mpl::identity<lslboost::parameter::aux::empty_arg_list>
//    ...>
//   >
...
#define BOOST_PARAMETER_template_args(z, n, prefix)                          \
    typename BOOST_PP_CAT(prefix, n) = ::lslboost::parameter::void_
/**/
...
#define BOOST_PARAMETER_make_arg_items_R(r, prefix, i, elem)                 \
    ::lslboost::parameter::aux::item<BOOST_PP_CAT(prefix, i),                   \
...
#define BOOST_PARAMETER_function_call_arg_list_R(r, seq)                     \
    ::lslboost::parameter::aux::make_arg_list<                                  \

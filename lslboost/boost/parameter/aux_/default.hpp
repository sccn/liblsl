...
namespace lslboost { namespace parameter { namespace aux {
    ...
    template <typename KW, typename DefaultComputer>
    struct lazy_default
      : ::lslboost::parameter::aux::lazy_default_base<KW,DefaultComputer>
    {
        inline BOOST_CONSTEXPR lazy_default(DefaultComputer& x)
          : ::lslboost::parameter::aux::lazy_default_base<KW,DefaultComputer>(x)
        {
        }
    };
...
#define BOOST_PARAMETER_lazy_default_fallback \
    ::lslboost::parameter::aux::lazy_default_base
/**/
#else
#define BOOST_PARAMETER_lazy_default_fallback \
    ::lslboost::parameter::aux::lazy_default
/**/
#endif

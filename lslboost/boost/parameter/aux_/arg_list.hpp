...
namespace lslboost { namespace parameter { namespace aux {
    ...
    struct empty_arg_list
    {
        struct tagged_arg
        {
            typedef ::lslboost::parameter::void_ value_type;
        };
        ...
        static ::lslboost::parameter::aux::no_tag has_key(KW*);
        ...
        inline BOOST_CONSTEXPR Default&
            operator[](::lslboost::parameter::aux::default_<K,Default> x) const
        {
            return x.value;
        }
        ...
        template <typename K, typename Default>
        inline BOOST_CONSTEXPR Default&&
            operator[](::lslboost::parameter::aux::default_r_<K,Default> x) const
        {
        ...
        typename ::lslboost::parameter::aux::result_of0<F>::type
        ...
        // MPL sequence support
        typedef ::lslboost::parameter::aux::empty_arg_list type; // convenience
        // For dispatching to sequence intrinsics
        typedef ::lslboost::parameter::aux::arg_list_tag tag;
    };
}}} // namespace lslboost::parameter::aux
...
namespace lslboost { namespace parameter { namespace aux {
    ...
    template <
        typename TaggedArg
      , typename Next = ::lslboost::parameter::aux::empty_arg_list
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
    ...
    {
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using _holds_maybe = typename ::lslboost::parameter::aux
     ...
     public:
        ...
        typedef ::lslboost::parameter::aux::arg_list<TaggedArg,Next> self;
        typedef typename TaggedArg::key_type key_type;

#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using reference = typename ::lslboost::mp11::mp_if<
            _holds_maybe
          , ::lslboost::parameter::aux
            ::get_reference<typename TaggedArg::value_type>
          , ::lslboost::parameter::aux::get_reference<TaggedArg>
        >::type;

        using value_type = ::lslboost::mp11
        ...
        inline BOOST_CONSTEXPR arg_list(
          ...
          , arg(::lslboost::parameter::aux::void_reference())
        {
        }
        ...
        struct binding
        {
            ...
            struct apply
            {
                typedef typename ::lslboost::mpl::eval_if<
                  ...
                  , ::lslboost::mpl::if_<Reference,reference,value_type>
                  , ::lslboost::mpl
...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
            template <typename KW, typename Default, typename Reference>
            using fn = ::lslboost::mp11::mp_if<
                ::std::is_same<KW,key_type>
              , ::lslboost::mp11::mp_if<Reference,reference,value_type>
              , ::lslboost::mp11::mp_apply_q<
                    next_binding
                  , ::lslboost::mp11::mp_list<KW,Default,Reference>
                >
            >;
#endif
        };
        ...
        static ::lslboost::parameter::aux::yes_tag has_key(key_type*);
        using Next::has_key;

     private:
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using _has_unique_key = ::lslboost::mp11::mp_bool<
#else
        typedef ::lslboost::mpl::bool_<
            ...
            ) == sizeof(::lslboost::parameter::aux::no_tag)
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        >;
#else
        > _has_unique_key;
...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
            get_default(D const&, ::lslboost::mp11::mp_false) const
#else
            get_default(D const&, ::lslboost::mpl::false_) const
#endif
        {
        ...
        inline BOOST_CONSTEXPR reference
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
            get_default(D const& d, ::lslboost::mp11::mp_true) const
#else
            get_default(D const& d, ::lslboost::mpl::true_) const
#endif
        {
            return (
                this->arg.get_value()
     ...
     public:
        inline BOOST_CONSTEXPR reference
            operator[](::lslboost::parameter::keyword<key_type> const&) const
        {
    ...
    !BOOST_WORKAROUND(BOOST_MSVC, < 1910)
        ...
        inline BOOST_CONSTEXPR reference
            operator[](
                ::lslboost::parameter::aux::default_<key_type,Default> const& d
            ) const
        {
        ...
        inline BOOST_CONSTEXPR reference
            operator[](
                ::lslboost::parameter::aux::default_r_<key_type,Default> const& d
            ) const
        {
            return this->get_default(d, _holds_maybe());
        }
    ...
    !BOOST_WORKAROUND(BOOST_MSVC, < 1910)
        ...
        static typename ::lslboost::lazy_enable_if<
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
            ::lslboost::mp11::mp_if<
                EmitsErrors
              ...
              , _has_unique_key
            >
          , ::lslboost::parameter::aux::augment_predicate_mp11<
#else
            typename ::lslboost::mpl::if_<
                EmitsErrors
              , ::lslboost::mpl::true_
        ...
        >::type
            satisfies(
                ::lslboost::parameter::aux::parameter_requirements<
                    key_type
                  , Predicate
                  , HasDefault
                >*
        ...
        inline BOOST_CONSTEXPR ::lslboost::parameter::aux::arg_list<
            ::lslboost::parameter::aux::tagged_argument<KW,T2>
          , self
        >
            operator,(
                ::lslboost::parameter::aux::tagged_argument<KW,T2> const& x
            ) const
        {
            return ::lslboost::parameter::aux::arg_list<
                ::lslboost::parameter::aux::tagged_argument<KW,T2>
              , self
            >(x, *this);
        }
        ...
        template <typename KW, typename T2>
        inline BOOST_CONSTEXPR ::lslboost::parameter::aux::arg_list<
            ::lslboost::parameter::aux::tagged_argument_rref<KW,T2>
          , self
        >
            operator,(
                ::lslboost::parameter::aux::tagged_argument_rref<KW,T2> const& x
            ) const
        {
            return ::lslboost::parameter::aux::arg_list<
                ::lslboost::parameter::aux::tagged_argument_rref<KW,T2>
...
namespace lslboost { namespace parameter { namespace aux {
    ...
    struct empty_arg_list
    {
        ...
        struct key_owner
        {
            ...
            struct apply
            {
                typedef ::lslboost::parameter::aux::empty_arg_list type;
            };
        };
...
namespace lslboost { namespace parameter { namespace aux {
    ...
    class arg_list : public Next
    {
     ...
     public:
        ...
        inline BOOST_CONSTEXPR arg_list(
            ...
            BOOST_PP_ENUM_BINARY_PARAMS(
              ...
              , ::lslboost::parameter::aux::void_reference()
            )
          , arg(a0)
        {
        }
     ...
     public:
            ...
            struct apply
            {
                typedef typename ::lslboost::mpl::eval_if<
                  ...
                  , ::lslboost::mpl::identity<
                        ::lslboost::parameter::aux::arg_list<TaggedArg,Next>
                    >
                  , ::lslboost::mpl::apply_wrap1<next_key_owner,KW>
                >::type type;
            };
        };
        ...
        // get() function.
        template <typename KW>
        inline BOOST_CONSTEXPR typename ::lslboost::mpl::apply_wrap3<
            binding
          , KW
          , ::lslboost::parameter::void_
          , ::lslboost::mpl::true_
        >::type
            operator[](::lslboost::parameter::keyword<KW> const& x) const
        {
            typename ::lslboost::mpl::apply_wrap1<key_owner,KW>::type const&
                sublist = *this;
        ...
        >::type
            operator[](
                ::lslboost::parameter::aux::default_<KW,Default> const& x
            ) const
        {
            typename ::lslboost::mpl::apply_wrap1<key_owner,KW>::type const&
                sublist = *this;
        ...
        // fails.
        inline BOOST_CONSTEXPR reference
            get(::lslboost::parameter::keyword<key_type> const&) const
        {
            BOOST_MPL_ASSERT_NOT((_holds_maybe));
            return this->arg.get_value();
        }
...
namespace lslboost { namespace parameter { namespace aux {
    ...
    struct arg_list_cons<>
    {
        using type = ::lslboost::parameter::aux::empty_arg_list;
    };

    template <typename ArgTuple0, typename ...Tuples>
    struct arg_list_cons<ArgTuple0,Tuples...>
    {
        using type = ::lslboost::parameter::aux::arg_list<
            typename ArgTuple0::tagged_arg
          , typename ::lslboost::parameter::aux::arg_list_cons<Tuples...>::type
    ...
    class flat_like_arg_list
      : public ::lslboost::parameter::aux::arg_list_cons<ArgTuples...>::type
    {
        using _base_type = typename ::lslboost::parameter::aux
     ...
     public:
        ...
        inline BOOST_CONSTEXPR ::lslboost::parameter::aux::flat_like_arg_list<
        ...
        {
            return ::lslboost::parameter::aux::flat_like_arg_list<
                ::lslboost::parameter::aux::flat_like_arg_tuple<
                    typename TaggedArg::base_type::key_type
                  , typename TaggedArg::base_type
                >
    ...
    template <>
    class flat_like_arg_list<>
      : public ::lslboost::parameter::aux::empty_arg_list
    {
        using _base_type = ::lslboost::parameter::aux::empty_arg_list;
...
namespace lslboost { namespace parameter { namespace aux {
    ...
    {
        typedef ::lslboost::mpl::forward_iterator_tag category;
    ...
    template <>
    struct arg_list_iterator< ::lslboost::parameter::aux::empty_arg_list>
    {
    };
}}} // namespace lslboost::parameter::aux
...
namespace lslboost { namespace mpl {
    ...
    template <>
    struct begin_impl< ::lslboost::parameter::aux::arg_list_tag>
    {
        template <typename S>
        struct apply
        {
            typedef ::lslboost::parameter::aux::arg_list_iterator<S> type;
        };
    };

    template <>
    struct end_impl< ::lslboost::parameter::aux::arg_list_tag>
    {
        template <typename>
        struct apply
        {
            typedef ::lslboost::parameter::aux::arg_list_iterator<
...
namespace lslboost { namespace mpl {
    ...
    template <>
    struct has_key_impl< ::lslboost::parameter::aux::arg_list_tag>
    {
...
namespace lslboost { namespace mpl {
    ...
    template <>
    struct count_impl< ::lslboost::parameter::aux::arg_list_tag>
    {
        template <typename ArgList, typename Keyword>
        struct apply
        {
...
namespace lslboost { namespace mpl {
    ...
    template <>
    struct key_type_impl< ::lslboost::parameter::aux::arg_list_tag>
    {
        template <typename ArgList, typename Keyword>
        struct apply
        {
...
namespace lslboost { namespace mpl {
    ...
    template <>
    struct value_type_impl< ::lslboost::parameter::aux::arg_list_tag>
      : ::lslboost::mpl::key_type_impl< ::lslboost::parameter::aux::arg_list_tag>
    {
    };
}} // namespace lslboost::mpl
...
namespace lslboost { namespace mpl {
    ...
    template <>
    struct at_impl< ::lslboost::parameter::aux::arg_list_tag>
      : ::lslboost::mpl::key_type_impl< ::lslboost::parameter::aux::arg_list_tag>
    {
    };
}} // namespace lslboost::mpl
...
namespace lslboost { namespace mpl {
    ...
    template <>
    struct order_impl< ::lslboost::parameter::aux::arg_list_tag>
    {
        template <typename ArgList, typename Keyword>
        struct apply
        {
            typedef typename ::lslboost::mpl::find<ArgList,Keyword>::type Itr;
            typedef typename ::lslboost::mpl::eval_if<
                ::lslboost::is_void<
                    typename ::lslboost::parameter
                    ::value_type<ArgList,Keyword,void>::type
                >
              , ::lslboost::mpl::identity< ::lslboost::mpl::void_>
              , ::lslboost::mpl::distance<
                    Itr
                  , ::lslboost::parameter::aux::arg_list_iterator<
                        ::lslboost::parameter::aux::empty_arg_list
                    >
                >
            >::type type;

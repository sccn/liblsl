...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
    using tagged_argument_type = ::lslboost::mp11::mp_if<
        ::lslboost::mp11::mp_if<
            ::std::is_scalar<Arg>
          ...
          , ::std::is_same<
            ...
            >
        >
      , ::lslboost::parameter::aux::error_lvalue_bound_to_consume_parameter
      , ::lslboost::mp11::mp_if<
            ::std::is_const<Arg>
          , ::lslboost::mp11::mp_if<
                ::std::is_same<
    ...
    struct tagged_argument_type
      : ::lslboost::mpl::eval_if<
            ::lslboost::is_same<
              ...
              , ::lslboost::parameter::out_reference
            >
          , ::lslboost::parameter::aux::error_const_lvalue_bound_to_out_parameter
          , ::lslboost::remove_const<Arg>
        >
    {
    };
...
namespace lslboost { namespace parameter { namespace aux {
    ...
    class tagged_argument
      : public ::lslboost::parameter::aux::tagged_argument_base
    {
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using arg_type = typename ::lslboost::parameter::aux
        ::tagged_argument_type<Keyword,Arg>::type;
#else
        typedef typename ::lslboost::mpl::eval_if<
            typename ::lslboost::mpl::eval_if<
                ::lslboost::is_scalar<Arg>
              , ::lslboost::mpl::false_
              , ::lslboost::is_same<
                    typename Keyword::qualifier
                  , ::lslboost::parameter::consume_reference
          ...
          , ::lslboost::parameter::aux::error_lvalue_bound_to_consume_parameter
          , ::lslboost::mpl::eval_if<
                ::lslboost::is_const<Arg>
              , ::lslboost::parameter::aux::tagged_argument_type<Keyword,Arg>
              , ::lslboost::mpl::identity<Arg>
            >
        >::type arg_type;
#endif  // BOOST_PARAMETER_CAN_USE_MP11
     ...
     public:
        ...
        // a lslboost::function or a std::function. -- Cromwell D. Enage
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using value_type = ::lslboost::mp11::mp_if<
        ...
        typedef typename ::lslboost::mpl::if_<
            ::lslboost::is_function<arg_type>
#if defined(BOOST_NO_CXX11_HDR_FUNCTIONAL)
          , ::lslboost::function<arg_type>
#else
          , ::std::function<arg_type>
#endif
          , Arg
...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using reference = ::lslboost::mp11::mp_if<
            ::std::is_function<arg_type>
          , value_type const&
          , Arg&
        >;
     ...
     public:
        ...
        inline BOOST_CONSTEXPR ::lslboost::parameter::aux::arg_list<
          ...
          , ::lslboost::parameter::aux::arg_list<
                ::lslboost::parameter::aux::tagged_argument<Keyword2,Arg2>
            >
        >
            operator,(
                ::lslboost::parameter::aux
            ...
            ) const
        {
            ...
            >(
              ...
              , ::lslboost::parameter::aux::arg_list<
                    ::lslboost::parameter::aux::tagged_argument<Keyword2,Arg2>
                >(x, ::lslboost::parameter::aux::empty_arg_list())
            );
        }
        ...
        inline BOOST_CONSTEXPR ::lslboost::parameter::aux::arg_list<
            ::lslboost::parameter::aux::tagged_argument<Keyword,Arg>
          , ::lslboost::parameter::aux::arg_list<
                ::lslboost::parameter::aux::tagged_argument_rref<Keyword2,Arg2>
            >
        >
            operator,(
                ::lslboost::parameter::aux
        ...
        inline BOOST_CONSTEXPR reference
            operator[](::lslboost::parameter::keyword<Keyword> const&) const
        {
        ...
        inline BOOST_CONSTEXPR reference
            operator[](
                ::lslboost::parameter::aux::default_<key_type,Default> const&
            ) const
        {
            return this->get_value();
        }
        ...
        inline BOOST_CONSTEXPR reference
            operator[](
                ::lslboost::parameter::aux::default_r_<key_type,Default> const&
            ) const
        {
            return this->get_value();
        }
        ...
        inline BOOST_CONSTEXPR reference
            operator[](
                ::lslboost::parameter::aux::lazy_default<key_type,F> const&
            ) const
        {
            return this->get_value();
        }
        ...
        inline BOOST_CONSTEXPR Default&&
            operator[](
                ::lslboost::parameter::aux::default_r_<KW,Default> const& x
            ) const
        {
        ...
        typename ::lslboost::parameter::aux::result_of0<F>::type
            operator[](
                ::lslboost::parameter::aux::lazy_default<KW,F> const& x
            ) const
        {
        ...
        typename ::lslboost::mpl::apply_wrap1<Predicate,value_type>::type
            satisfies(
        ...
        typedef ::lslboost::parameter::aux::tagged_argument<Keyword,Arg> type;
        // For the benefit of iterators
        typedef ::lslboost::parameter::aux::empty_arg_list tail_type;
    ...
    using tagged_argument_rref_key = ::lslboost::mp11::mp_if<
        ::std::is_same<
            typename Keyword::qualifier
          , ::lslboost::parameter::out_reference
        >
      , ::lslboost::parameter::aux::error_rvalue_bound_to_out_parameter
      , ::lslboost::mp11::mp_identity<Keyword>
    >;
#endif
    ...
    {
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using key_type = typename ::lslboost::parameter::aux
     ...
     public:
            ...
            ) const
        {
            ...
            >(
                *this
              , ::lslboost::parameter::aux::arg_list<
                    ::lslboost::parameter::aux::tagged_argument_rref<
                        Keyword2
                      , Arg2
                    >
                >(x, ::lslboost::parameter::aux::empty_arg_list())
...
namespace lslboost { namespace parameter { namespace aux {
    ...
    class tagged_argument
      : public ::lslboost::parameter::aux::tagged_argument_base
    {
        typedef typename ::lslboost::remove_const<Arg>::type arg_type;
     ...
     public:
        ...
        // Useful for argument lists with undetermined length.
        template <typename Keyword2, typename Arg2>
        inline ::lslboost::parameter::aux::arg_list<
            ::lslboost::parameter::aux::tagged_argument<Keyword,Arg>
          , ::lslboost::parameter::aux::arg_list<
                ::lslboost::parameter::aux::tagged_argument<Keyword2,Arg2>
            >
    ...
    struct tagged_argument_list_of_1 : public TaggedArg
    {
            ...
            operator,(TA2 const& x) const
        {
            ...
            >(
              ...
              , ::lslboost::parameter::aux::arg_list<typename TA2::base_type>(

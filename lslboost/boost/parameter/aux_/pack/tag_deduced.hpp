...
namespace lslboost { namespace parameter { namespace aux {
    ...
    {
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using type = ::lslboost::mp11::mp_list<
            ::lslboost::mp11::mp_apply_q<
                TagFn
              , ::lslboost::mp11::mp_list<
                    typename ::lslboost::parameter::aux::tag_type<Spec>::type
                  , Arg
                >
            >
#else
        typedef ::lslboost::mpl::pair<
            typename ::lslboost::mpl::apply_wrap2<
                TagFn
              , typename ::lslboost::parameter::aux::tag_type<Spec>::type
              , Arg
            >::type
#endif  // BOOST_PARAMETER_CAN_USE_MP11
          , typename ::lslboost::parameter::aux::insert_<
                UsedArgs
              , typename ::lslboost::parameter::aux::tag_type<Spec>::type
            >::type
#if defined(BOOST_PARAMETER_CAN_USE_MP11)

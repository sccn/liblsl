...
namespace lslboost { namespace parameter { namespace aux {
    ...
    {
        typedef ::lslboost::parameter::aux::parameter_requirements<
            typename ::lslboost::parameter::aux::tag_type<ParameterSpec>::type
          , typename ::lslboost::parameter::aux::predicate<ParameterSpec>::type
          , ::lslboost::parameter::aux::has_default<ParameterSpec>
        > type;
    };

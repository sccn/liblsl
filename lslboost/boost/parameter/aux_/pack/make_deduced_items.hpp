...
namespace lslboost { namespace parameter { namespace aux {
...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
    using make_deduced_items = ::lslboost::mp11::mp_if<
        ::std::is_same<Spec,::lslboost::parameter::void_>
      , ::lslboost::mp11::mp_identity< ::lslboost::parameter::void_>
      , ::lslboost::mp11::mp_if<
            ::lslboost::parameter::aux::is_deduced<Spec>
          , ::lslboost::parameter::aux::make_deduced_item<Spec,Tail>
          , Tail
        >
    >;
#else
    struct make_deduced_items
      : ::lslboost::mpl::eval_if<
            ::lslboost::is_same<Spec,::lslboost::parameter::void_>

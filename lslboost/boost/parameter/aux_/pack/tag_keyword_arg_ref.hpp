...
namespace lslboost { namespace parameter { namespace aux { 
    ...
    struct tag_ref<Keyword,ActualArg,::lslboost::mpl::false_>
    {
...
namespace lslboost { namespace parameter { namespace aux {
    ...
    struct tag_keyword_arg_ref
    {
        ...
        struct apply
        {
            typedef typename ::lslboost::parameter::aux::tag_ref<K,T>::type type;
        };

#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        template <typename K, typename T>
        using fn = typename ::lslboost::parameter::aux::tag_ref<K,T>::type;
#endif
    };

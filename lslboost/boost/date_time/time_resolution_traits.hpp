...
namespace date_time {
  ...
  //
  // In Boost 1.65.1 and earlier var_type was lslboost::int32_t which suffers
  ...
  //
  // In Boost 1.67.0 the var_type was changed to lslboost::int64_t, 
  ...
  template<typename frac_sec_type,
           ...
           typename var_type = lslboost::int64_t >     // see note above

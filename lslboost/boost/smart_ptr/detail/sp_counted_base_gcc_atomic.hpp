...
inline void atomic_increment( lslboost::uint_least32_t * pw )
{
    __atomic_fetch_add( pw, 1, __ATOMIC_RELAXED );
}

inline lslboost::uint_least32_t atomic_decrement( lslboost::uint_least32_t * pw )
{
    return __atomic_fetch_sub( pw, 1, __ATOMIC_ACQ_REL );
}

inline lslboost::uint_least32_t atomic_conditional_increment( lslboost::uint_least32_t * pw )
{
    // long r = *pw;
    // if( r != 0 ) ++*pw;
    // return r;

    lslboost::uint_least32_t r = __atomic_load_n( pw, __ATOMIC_RELAXED );
...
inline lslboost::uint_least32_t atomic_load( lslboost::uint_least32_t const * pw )
{
...
private:
    ...
    lslboost::uint_least32_t use_count_;        // #shared
    lslboost::uint_least32_t weak_count_;       // #weak + (#shared != 0)

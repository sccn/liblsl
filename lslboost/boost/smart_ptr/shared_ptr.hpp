...
public:
    ...
    template<class D> shared_ptr( lslboost::detail::sp_nullptr_t p, D d ): px( p ), pn( p, static_cast< D&& >( d ) )
    {
    }
    ...
    template<class D, class A> shared_ptr( lslboost::detail::sp_nullptr_t p, D d, A a ): px( p ), pn( p, static_cast< D&& >( d ), a )
    {
    }
...
#include <boost/smart_ptr/detail/operator_bool.hpp>
    ...
    void * _internal_get_deleter( lslboost::detail::sp_typeinfo_ const & ti ) const BOOST_SP_NOEXCEPT
    {
        return pn.get_deleter( ti );
    }

    void * _internal_get_local_deleter( lslboost::detail::sp_typeinfo_ const & ti ) const BOOST_SP_NOEXCEPT
    {
    ...
    lslboost::detail::shared_count _internal_count() const BOOST_SP_NOEXCEPT
    {
        return pn;
    }
...
template<class T> struct hash< ::lslboost::shared_ptr<T> >
{
    std::size_t operator()( ::lslboost::shared_ptr<T> const & p ) const BOOST_SP_NOEXCEPT
    {
        return std::hash< typename ::lslboost::shared_ptr<T>::element_type* >()( p.get() );
    }
};

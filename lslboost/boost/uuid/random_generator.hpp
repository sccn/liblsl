...
private:
    ...
    typename lslboost::enable_if<detail::has_member_function_seed<MaybePseudoRandomNumberGenerator, void> >::type
    ...
    template<class MaybePseudoRandomNumberGenerator>
    typename lslboost::disable_if<detail::has_member_function_seed<MaybePseudoRandomNumberGenerator, void> >::type
...
public:
    ...
    random_generator_pure(BOOST_RV_REF(random_generator_pure) that) BOOST_NOEXCEPT :
        prov_(lslboost::move(that.prov_))
    {
    }

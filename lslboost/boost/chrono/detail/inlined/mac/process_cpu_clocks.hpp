  ...
  namespace chrono
  {
    ...
    process_real_cpu_clock::time_point process_real_cpu_clock::now(system::error_code & ec)
    {
      ...
      if (c == clock_t(-1)) // error
      {
        ...
        {
          lslboost::throw_exception(system::system_error(errno, ::lslboost::system::system_category(), "chrono::process_real_cpu_clock"));
        } else
        {
    ...
    process_user_cpu_clock::time_point process_user_cpu_clock::now(system::error_code & ec)
    {
      ...
      if (c == clock_t(-1)) // error
      {
        if (::lslboost::chrono::is_throws(ec))
        {
          lslboost::throw_exception(system::system_error(errno, ::lslboost::system::system_category(), "chrono::process_user_cpu_clock"));
        } else
        {
          ec.assign(errno, ::lslboost::system::system_category());
          return time_point();
    ...
    process_system_cpu_clock::time_point process_system_cpu_clock::now(system::error_code & ec)
    {
      ...
      if (c == clock_t(-1)) // error
      {
        if (::lslboost::chrono::is_throws(ec))
        {
          lslboost::throw_exception(system::system_error(errno, ::lslboost::system::system_category(), "chrono::process_system_cpu_clock"));
        } else
        {
          ec.assign(errno, ::lslboost::system::system_category());
          return time_point();
    ...
    process_cpu_clock::time_point process_cpu_clock::now(system::error_code & ec)
    {
      ...
      if (c == clock_t(-1)) // error
      {
        if (::lslboost::chrono::is_throws(ec))
        {
          lslboost::throw_exception(system::system_error(errno, ::lslboost::system::system_category(), "chrono::process_clock"));
        } else
        {
          ec.assign(errno, ::lslboost::system::system_category());
          return time_point();

...
#define BOOST_MATH_META_INT(type, name, Default)\
   template <type N = Default> struct name : public lslboost::integral_constant<int, N>{};\
   namespace detail{\
   template <type N>\
   ...
   template <class T> struct is_##name : public lslboost::integral_constant<bool, ::lslboost::math::policies::detail::is_##name##_imp<T>::value>{};

#define BOOST_MATH_META_BOOL(name, Default)\
   template <bool N = Default> struct name : public lslboost::integral_constant<bool, N>{};\
   namespace detail{\
   template <bool N>\
   char test_is_valid_arg(const name<N>*);\
   char test_is_default_arg(const name<Default>*);\
...
: public lslboost::integral_constant<bool, ::lslboost::math::policies::detail::is_valid_policy_imp<T>::value>
{};

template <class T> struct is_default_policy 
: public lslboost::integral_constant<bool, ::lslboost::math::policies::detail::is_default_policy_imp<T>::value>
{
   template <class U>
   struct apply
   {
...
public:
   typedef policy<
      typename mpl::at<result_type, lslboost::integral_constant<int, 0> >::type,
      typename mpl::at<result_type, lslboost::integral_constant<int, 1> >::type,
      typename mpl::at<result_type, lslboost::integral_constant<int, 2> >::type,
      typename mpl::at<result_type, lslboost::integral_constant<int, 3> >::type,
      typename mpl::at<result_type, lslboost::integral_constant<int, 4> >::type,
      typename mpl::at<result_type, lslboost::integral_constant<int, 5> >::type,
      typename mpl::at<result_type, lslboost::integral_constant<int, 6> >::type,
      typename mpl::at<result_type, lslboost::integral_constant<int, 7> >::type,
      typename mpl::at<result_type, lslboost::integral_constant<int, 8> >::type,
      typename mpl::at<result_type, lslboost::integral_constant<int, 9> >::type,
      typename mpl::at<result_type, lslboost::integral_constant<int, 10> >::type,
      typename mpl::at<result_type, lslboost::integral_constant<int, 11> >::type,
      typename mpl::at<result_type, lslboost::integral_constant<int, 12> >::type > type;
};
//
...
template <class Real>
struct basic_digits : public lslboost::integral_constant<int, 0>{ };
template <>
struct basic_digits<float> : public lslboost::integral_constant<int, FLT_MANT_DIG>{ };
template <>
struct basic_digits<double> : public lslboost::integral_constant<int, DBL_MANT_DIG>{ };
template <>
struct basic_digits<long double> : public lslboost::integral_constant<int, LDBL_MANT_DIG>{ };
...
struct precision
{
   ...
   typedef typename mpl::if_<
      mpl::equal_to<digits_t, lslboost::integral_constant<int, 0> >,
      // Possibly unknown precision:
      precision_type,
      typename mpl::if_<
         mpl::or_<mpl::less_equal<digits_t, precision_type>, mpl::less_equal<precision_type, lslboost::integral_constant<int, 0> > >,
...
#else
   typedef typename Policy::precision_type precision_type;
   typedef lslboost::integral_constant<int, ::std::numeric_limits<Real>::digits> digits_t;
   typedef lslboost::integral_constant<bool, ::std::numeric_limits<Real>::is_specialized> spec_t;
   typedef typename mpl::if_<
      mpl::or_<mpl::equal_to<spec_t, lslboost::true_type>, mpl::equal_to<digits_t, lslboost::integral_constant<int, 0> > >,
      // Possibly unknown precision:
      precision_type,
      typename mpl::if_<
         mpl::or_<mpl::less_equal<digits_t, precision_type>, mpl::less_equal<precision_type, lslboost::integral_constant<int, 0> > >,
...
{
   typedef lslboost::integral_constant<int, 113> type;
};
...
inline BOOST_MATH_CONSTEXPR int digits_imp(lslboost::true_type const&) BOOST_NOEXCEPT
{
...
template <class T, class Policy>
inline BOOST_MATH_CONSTEXPR int digits_imp(lslboost::false_type const&) BOOST_NOEXCEPT
{
...
{
   typedef lslboost::integral_constant<bool, std::numeric_limits<T>::is_specialized > tag_type;
...
struct series_factor_calc<T, Digits, lslboost::true_type, lslboost::true_type>
{
...
template <class T, class Digits>
struct series_factor_calc<T, Digits, lslboost::true_type, lslboost::false_type>
{
   static BOOST_MATH_CONSTEXPR T get() BOOST_MATH_NOEXCEPT(T)
   {
...
template <class T, class Digits>
struct series_factor_calc<T, Digits, lslboost::false_type, lslboost::true_type>
{
   static BOOST_MATH_CONSTEXPR T get() BOOST_MATH_NOEXCEPT(T)
   {
      return lslboost::math::tools::epsilon<T>();
...
template <class T, class Policy>
inline BOOST_MATH_CONSTEXPR T get_epsilon_imp(lslboost::true_type const&) BOOST_MATH_NOEXCEPT(T)
{
#ifndef BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
   BOOST_STATIC_ASSERT( ::std::numeric_limits<T>::is_specialized);
...
#endif
   typedef typename lslboost::math::policies::precision<T, Policy>::type p_t;
   typedef lslboost::integral_constant<bool, p_t::value <= std::numeric_limits<lslboost::uintmax_t>::digits> is_small_int;
   typedef lslboost::integral_constant<bool, p_t::value >= std::numeric_limits<T>::digits> is_default_value;
   return series_factor_calc<T, p_t, is_small_int, is_default_value>::get();
}

template <class T, class Policy>
inline BOOST_MATH_CONSTEXPR T get_epsilon_imp(lslboost::false_type const&) BOOST_MATH_NOEXCEPT(T)
{
...
{
   typedef lslboost::integral_constant<bool, (std::numeric_limits<T>::is_specialized && (std::numeric_limits<T>::radix == 2)) > tag_type;
...
template <class P>
struct is_policy : public lslboost::integral_constant<bool, ::lslboost::math::policies::detail::is_policy_imp<P>::value> {};

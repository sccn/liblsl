...
namespace lslboost
{
   ...
   namespace detail{
      ...
      typedef lslboost::integral_constant<int, 0> bessel_no_int_tag;      // No integer optimisation possible.
      typedef lslboost::integral_constant<int, 1> bessel_maybe_int_tag;   // Maybe integer optimisation.
      typedef lslboost::integral_constant<int, 2> bessel_int_tag;         // Definite integer optimisation.
      ...
      struct bessel_traits
      {
         ...
         typedef typename mpl::if_<
            mpl::or_<
               mpl::less_equal<precision_type, lslboost::integral_constant<int, 0> >,
               mpl::greater<precision_type, lslboost::integral_constant<int, 64> > >,
            bessel_no_int_tag,
            typename mpl::if_<
               is_integral<T1>,
               bessel_int_tag,
         ...
         typedef typename mpl::if_<
            mpl::or_<
               mpl::less_equal<precision_type, lslboost::integral_constant<int, 0> >,
               mpl::greater<precision_type, lslboost::integral_constant<int, 113> > >,
            bessel_no_int_tag,
            typename mpl::if_<
               is_integral<T1>,
               bessel_int_tag,
...
\
   using lslboost::math::chebyshev_next;\
\
  template<class Real>\
  Real chebyshev_t(unsigned n, Real const & x){ return ::lslboost::math::chebyshev_t(n, x, Policy()); }\
\
  template<class Real>\
  Real chebyshev_u(unsigned n, Real const & x){ return ::lslboost::math::chebyshev_u(n, x, Policy()); }\
\
  template<class Real>\
  Real chebyshev_t_prime(unsigned n, Real const & x){ return ::lslboost::math::chebyshev_t_prime(n, x, Policy()); }\
\
  using ::lslboost::math::chebyshev_clenshaw_recurrence;\
\
   template <class T1, class T2>\

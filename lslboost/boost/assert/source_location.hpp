...
private:
    ...
    lslboost::uint_least32_t line_;
    lslboost::uint_least32_t column_;
...
public:
    ...
    BOOST_CONSTEXPR source_location( char const * file, lslboost::uint_least32_t ln, char const * function, lslboost::uint_least32_t col = 0 ) BOOST_NOEXCEPT: file_( file ), function_( function ), line_( ln ), column_( col )
    {
    }
    ...
    BOOST_CONSTEXPR lslboost::uint_least32_t line() const BOOST_NOEXCEPT
    {
        return line_;
    }

    BOOST_CONSTEXPR lslboost::uint_least32_t column() const BOOST_NOEXCEPT
    {
        return column_;
    }

...
addressof(T& o) BOOST_NOEXCEPT
{
    ...
    return lslboost::detail::addrof<T>::get(o, 0);
#else
    return lslboost::detail::addrof<T>::get(lslboost::detail::addrof_ref<T>(o), 0);
#endif
}
...
BOOST_FORCEINLINE typename lslboost::detail::addrof_result<T[N]>::type
...
addressof(T& o) BOOST_NOEXCEPT
{
    return lslboost::detail::addressof(o);
}
#endif

 ...
 *       lslboost::system::error_code error = {},
 *       std::size_t n = 0)
 *   {
 *     switch (state_)
 *     {
 ...
 *       {
 *         state_ = writing;
 *         lslboost::asio::async_write(socket_, buffer_,
 *             lslboost::asio::transfer_exactly(n),
 *             std::move(self));
 *       }
 *       break;
 *     case writing:
 ...
 *       void(lslboost::system::error_code, std::size_t)>::return_type
 * {
 *   return lslboost::asio::async_compose<CompletionToken,

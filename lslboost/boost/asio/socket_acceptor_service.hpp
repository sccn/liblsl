...
public:
  ...
  explicit socket_acceptor_service(lslboost::asio::io_context& io_context)
  ...
  BOOST_ASIO_SYNC_OP_VOID wait(implementation_type& impl,
      socket_base::wait_type w, lslboost::system::error_code& ec)
  {
  ...
  async_accept(implementation_type& impl,
      lslboost::asio::io_context* peer_io_context, endpoint_type* peer_endpoint,

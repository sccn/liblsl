...
public:
  ...
  // Constructor.
  BOOST_ASIO_DECL resolver_service_base(lslboost::asio::io_context& io_context);
...
private:
  ...
  lslboost::asio::detail::scoped_ptr<lslboost::asio::io_context> work_io_context_;
  ...
  lslboost::asio::executor_work_guard<
      lslboost::asio::io_context::executor_type> work_;

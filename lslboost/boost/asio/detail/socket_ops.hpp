...
BOOST_ASIO_DECL signed_size_type recv1(socket_type s,
    void* data, size_t size, int flags, lslboost::system::error_code& ec);
...
BOOST_ASIO_DECL signed_size_type send1(socket_type s,
    const void* data, size_t size, int flags, lslboost::system::error_code& ec);
...
BOOST_ASIO_DECL int poll_read(socket_type s,
    state_type state, int msec, lslboost::system::error_code& ec);

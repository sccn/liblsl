...
inline void get_last_error(
    lslboost::system::error_code& ec, bool is_error_condition)
{
    ...
    std::size_t addrlen, lslboost::system::error_code& ec)
{
  ...
  if (result != 0 && ec == lslboost::asio::error::try_again)
...
size_t sync_recv1(socket_type s, state_type state, void* data,
    size_t size, int flags, lslboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = lslboost::asio::error::bad_descriptor;
...
int poll_read(socket_type s, state_type state,
    int msec, lslboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = lslboost::asio::error::bad_descriptor;
...
int poll_connect(socket_type s, int msec, lslboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = lslboost::asio::error::bad_descriptor;

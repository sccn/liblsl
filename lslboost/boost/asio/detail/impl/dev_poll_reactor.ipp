...
dev_poll_reactor::dev_poll_reactor(lslboost::asio::execution_context& ctx)
  : lslboost::asio::detail::execution_context_service_base<dev_poll_reactor>(ctx),
...
void dev_poll_reactor::notify_fork(
    lslboost::asio::execution_context::fork_event fork_ev)
{
  if (fork_ev == lslboost::asio::execution_context::fork_child)
  {

...
public:
  invoker(const implementation_type& impl, Executor& ex)
    : impl_(impl),
      executor_(lslboost::asio::prefer(ex, execution::outstanding_work.tracked))
  {
  }
  ...
  struct on_invoker_exit
  {
    ...
    ~on_invoker_exit()
    {
      ...
      if (more_handlers)
      {
        ...
        execution::execute(
            lslboost::asio::prefer(
              lslboost::asio::require(this_->executor_,
    ...
    >::type*)
{
  return strand_executor_service::do_execute(impl, ex,
      ...
      lslboost::asio::query(ex, execution::allocator));
}
    ...
    Executor& ex, BOOST_ASIO_MOVE_ARG(Function) function, const Allocator& a)
{
  ...
  if (lslboost::asio::query(ex, execution::blocking) != execution::blocking.never

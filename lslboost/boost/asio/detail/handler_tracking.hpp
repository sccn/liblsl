...
# define BOOST_ASIO_HANDLER_LOCATION(args) \
  lslboost::asio::detail::handler_tracking::location tracked_location args
...
# define BOOST_ASIO_HANDLER_REACTOR_REGISTRATION(args) \
  lslboost::asio::detail::handler_tracking::reactor_registration args

# define BOOST_ASIO_HANDLER_REACTOR_DEREGISTRATION(args) \
  lslboost::asio::detail::handler_tracking::reactor_deregistration args
...
# define BOOST_ASIO_HANDLER_REACTOR_EVENTS(args) \
  lslboost::asio::detail::handler_tracking::reactor_events args

# define BOOST_ASIO_HANDLER_REACTOR_OPERATION(args) \
  lslboost::asio::detail::handler_tracking::reactor_operation args

...
public:
    ...
    : count_(0), total_buffer_size_(0)
  {
    buffer_sequence_adapter::init(
        lslboost::asio::buffer_sequence_begin(buffer_sequence),
        lslboost::asio::buffer_sequence_end(buffer_sequence));
  }
  ...
  static Buffer linearise(const Buffers& buffer_sequence,
      const lslboost::asio::mutable_buffer& storage)
  {
    return buffer_sequence_adapter::linearise(
        lslboost::asio::buffer_sequence_begin(buffer_sequence),
        lslboost::asio::buffer_sequence_end(buffer_sequence), storage);
  }
...
private:
  ...
  static Buffer linearise(Iterator begin, Iterator end,
      const lslboost::asio::mutable_buffer& storage)
  {
    lslboost::asio::mutable_buffer unused_storage = storage;
    Iterator iter = begin;
    while (iter != end && unused_storage.size() != 0)
    {
      ...
      unused_storage += lslboost::asio::buffer_copy(unused_storage, buffer);
    }
...
class buffer_sequence_adapter<Buffer, lslboost::asio::mutable_buffer>
  : buffer_sequence_adapter_base
{
public:
  ...
  explicit buffer_sequence_adapter(
      const lslboost::asio::mutable_buffer& buffer_sequence)
  {
  ...
  static bool all_empty(const lslboost::asio::mutable_buffer& buffer_sequence)
  {
    return buffer_sequence.size() == 0;
  }

  static void validate(const lslboost::asio::mutable_buffer& buffer_sequence)
  {
    buffer_sequence.data();
  }

  static Buffer first(const lslboost::asio::mutable_buffer& buffer_sequence)
  {
  ...
  static Buffer linearise(const lslboost::asio::mutable_buffer& buffer_sequence,
      const Buffer&)
  {
    return Buffer(buffer_sequence);
  }
...
template <typename Buffer>
class buffer_sequence_adapter<Buffer, lslboost::asio::const_buffer>
  : buffer_sequence_adapter_base
{
public:
  enum { is_single_buffer = true };
  ...
  explicit buffer_sequence_adapter(
      const lslboost::asio::const_buffer& buffer_sequence)
  {
    init_native_buffer(buffer_, Buffer(buffer_sequence));
    total_buffer_size_ = buffer_sequence.size();
  }
  ...
  static bool all_empty(const lslboost::asio::const_buffer& buffer_sequence)
  {
    return buffer_sequence.size() == 0;
  }

  static void validate(const lslboost::asio::const_buffer& buffer_sequence)
  {
    buffer_sequence.data();
  }

  static Buffer first(const lslboost::asio::const_buffer& buffer_sequence)
  {
    return Buffer(buffer_sequence);
  }
  ...
  static Buffer linearise(const lslboost::asio::const_buffer& buffer_sequence,
      const Buffer&)
  {
    return Buffer(buffer_sequence);
  }
...
public:
  ...
  static Buffer linearise(const lslboost::asio::mutable_buffers_1& buffer_sequence,
      const Buffer&)
  {
    return Buffer(buffer_sequence);
  }
...
public:
  ...
  static Buffer linearise(const lslboost::asio::const_buffers_1& buffer_sequence,
      const Buffer&)
  {
    return Buffer(buffer_sequence);
  }
...
public:
  ...
  static Buffer linearise(const lslboost::array<Elem, 2>& buffer_sequence,
      const lslboost::asio::mutable_buffer& storage)
  {
    ...
    return Buffer(storage.data(),
        lslboost::asio::buffer_copy(storage, buffer_sequence));
  }

...
{
public:
  reactive_socket_accept_op_base(const lslboost::system::error_code& success_ec,
...
public:
  ...
  reactive_socket_accept_op(const lslboost::system::error_code& success_ec,
      socket_type socket, socket_ops::state_type state, Socket& peer,
      const Protocol& protocol, typename Protocol::endpoint* peer_endpoint,
...
public:
  ...
  reactive_socket_move_accept_op(const lslboost::system::error_code& success_ec,
      ...
      std::size_t /*bytes_transferred*/)
  {
    ...
    detail::move_binder2<Handler,
      lslboost::system::error_code, peer_socket_type>

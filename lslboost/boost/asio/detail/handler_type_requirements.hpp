...
#define BOOST_ASIO_LEGACY_COMPLETION_HANDLER_CHECK( \
  ...
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(lslboost::asio::detail::zero_arg_copyable_handler_test( \
...
#define BOOST_ASIO_MOVE_ACCEPT_HANDLER_CHECK( \
  ...
  \
  typedef BOOST_ASIO_HANDLER_TYPE(handler_type, \
      void(lslboost::system::error_code, socket_type)) \
    asio_true_handler_type; \
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(lslboost::asio::detail::two_arg_move_handler_test( \
          lslboost::asio::detail::rvref< \
            asio_true_handler_type>(), \
          static_cast<const lslboost::system::error_code*>(0), \
  ...
  typedef lslboost::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        lslboost::asio::detail::lvref< \
          asio_true_handler_type>()( \
            lslboost::asio::detail::lvref<const lslboost::system::error_code>(), \
            lslboost::asio::detail::rvref<socket_type>()), \
        char(0))> BOOST_ASIO_UNUSED_TYPEDEF
...
#define BOOST_ASIO_RANGE_CONNECT_HANDLER_CHECK( \
  ...
  \
  typedef BOOST_ASIO_HANDLER_TYPE(handler_type, \
      void(lslboost::system::error_code, endpoint_type)) \
    asio_true_handler_type; \
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(lslboost::asio::detail::two_arg_handler_test( \
  ...
  typedef lslboost::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        lslboost::asio::detail::lvref< \
          asio_true_handler_type>()( \
            lslboost::asio::detail::lvref<const lslboost::system::error_code>(), \
            lslboost::asio::detail::lvref<const endpoint_type>()), \
        char(0))> BOOST_ASIO_UNUSED_TYPEDEF
...
#define BOOST_ASIO_RESOLVE_HANDLER_CHECK( \
  ...
  \
  typedef BOOST_ASIO_HANDLER_TYPE(handler_type, \
      void(lslboost::system::error_code, range_type)) \
    asio_true_handler_type; \
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(lslboost::asio::detail::two_arg_handler_test( \
  ...
  typedef lslboost::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        lslboost::asio::detail::lvref< \
          asio_true_handler_type>()( \
            lslboost::asio::detail::lvref<const lslboost::system::error_code>(), \
            lslboost::asio::detail::lvref<const range_type>()), \
        char(0))> BOOST_ASIO_UNUSED_TYPEDEF

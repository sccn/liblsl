 ...
 * expression <tt>lslboost::asio::require(E, P0, Pn...)</tt> for some
 ...
 *   <tt>lslboost::asio::require(E, P0, Pn...)</tt> is ill-formed.
 *
 ...
 *
 * @li Otherwise,
 *   <tt>lslboost::asio::require(lslboost::asio::require(E, P0), Pn...)</tt>
 *   if <tt>N > 0</tt> and the expression
 *   <tt>lslboost::asio::require(lslboost::asio::require(E, P0), Pn...)</tt>
 *   is a valid expression.
 *
 * @li Otherwise, <tt>lslboost::asio::require(E, P0, Pn...)</tt> is ill-formed.
 */
 ...
 * @c true_type if the expression <tt>lslboost::asio::require(std::declval<T>(),
 ...
 * type of the expression <tt>lslboost::asio::require(std::declval<T>(),

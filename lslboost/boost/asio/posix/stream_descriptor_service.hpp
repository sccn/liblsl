...
public:
  ...
  static lslboost::asio::io_context::id id;
#endif
...
public:
  ...
  explicit stream_descriptor_service(lslboost::asio::io_context& io_context)
    : lslboost::asio::detail::service_base<stream_descriptor_service>(io_context),
  ...
  BOOST_ASIO_SYNC_OP_VOID wait(implementation_type& impl,
      descriptor_base::wait_type w, lslboost::system::error_code& ec)
  {
  ...
  {
    lslboost::asio::async_completion<WriteHandler,
  ...
  {
    lslboost::asio::async_completion<ReadHandler,
      void (lslboost::system::error_code, std::size_t)> init(handler);

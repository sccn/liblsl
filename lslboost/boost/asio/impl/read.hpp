...
namespace detail
{
      ...
      CompletionCondition completion_condition, lslboost::system::error_code& ec)
  {
    ...
    lslboost::asio::detail::consuming_buffers<mutable_buffer,
    ...
    >::type*)
{
  return detail::read_buffer_sequence(s, buffers,
      lslboost::asio::buffer_sequence_begin(buffers), completion_condition, ec);
}
    ...
    >::type*)
{
  ...
  detail::start_read_buffer_sequence_op(s, buffers,
      lslboost::asio::buffer_sequence_begin(buffers), completion_condition,
    ...
    >::type*)
{
  ...
  detail::start_read_buffer_sequence_op(s, buffers,
      lslboost::asio::buffer_sequence_begin(buffers), transfer_all(),
      init.completion_handler);

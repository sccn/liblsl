      ...
      BOOST_ASIO_HANDLER_TYPE(ReadHandler,
        void (lslboost::system::error_code, std::size_t))>(
          s, BOOST_ASIO_MOVE_CAST(DynamicBuffer)(buffers),
            delim, init.completion_handler)(lslboost::system::error_code(), 0, 1);
        ...
        void (lslboost::system::error_code, std::size_t))>(
          s, BOOST_ASIO_MOVE_CAST(DynamicBuffer)(buffers),
            static_cast<std::string>(delim),
              init.completion_handler)(lslboost::system::error_code(), 0, 1);
  ...
  detail::read_until_expr_op<AsyncReadStream,
    typename decay<DynamicBuffer>::type,
      lslboost::regex, BOOST_ASIO_HANDLER_TYPE(ReadHandler,
        void (lslboost::system::error_code, std::size_t))>(
          s, BOOST_ASIO_MOVE_CAST(DynamicBuffer)(buffers),
            expr, init.completion_handler)(lslboost::system::error_code(), 0, 1);

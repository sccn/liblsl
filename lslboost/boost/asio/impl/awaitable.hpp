...
public:
  ...
  void* operator new(std::size_t size)
  {
    return lslboost::asio::detail::thread_info_base::allocate(
        lslboost::asio::detail::thread_info_base::awaitable_frame_tag(),
        lslboost::asio::detail::thread_context::thread_call_stack::top(),
        size);
  }
  ...
  void set_error(const lslboost::system::error_code& ec)
  {
    this->set_except(std::make_exception_ptr(lslboost::system::system_error(ec)));
  }
...
struct coroutine_traits<lslboost::asio::awaitable<T, Executor>, Args...>
{
  typedef lslboost::asio::detail::awaitable_frame<T, Executor> promise_type;
};

 ...
 * expression <tt>lslboost::asio::require_concept(E, P)</tt> for some
 ...
 *   with value <tt>true</tt>, <tt>lslboost::asio::require_concept(E, P)</tt> is
 *   ill-formed.
 *
 ...
 *
 * @li Otherwise, <tt>lslboost::asio::require_concept(E, P)</tt> is ill-formed.
 */
 ...
 * <tt>lslboost::asio::require_concept(std::declval<T>(),
...
using lslboost::asio::traits::require_concept_free;
using lslboost::asio::traits::require_concept_member;
using lslboost::asio::traits::static_require_concept;

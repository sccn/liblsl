 ...
 * @code
 * lslboost::asio::ip::tcp::acceptor acceptor(io_context);
...
public:
   ...
   * acceptor.
   */
  explicit basic_socket_acceptor(lslboost::asio::io_context& io_context)
   ...
   */
  basic_socket_acceptor(lslboost::asio::io_context& io_context,
   ...
   * ...
   * lslboost::system::error_code ec;
   * acceptor.listen(lslboost::asio::socket_base::max_listen_connections, ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
   * @endcode
   */
  BOOST_ASIO_SYNC_OP_VOID listen(int backlog, lslboost::system::error_code& ec)
  {
    this->get_service().listen(this->get_implementation(), backlog, ec);
    BOOST_ASIO_SYNC_OP_VOID_RETURN(ec);
  }
   ...
   * passed the lslboost::asio::error::operation_aborted error. Ownership of the
   * native acceptor is then transferred to the caller.
   *
   * @throws lslboost::system::system_error Thrown on failure.
   *
   * @note This function is unsupported on Windows versions prior to Windows
   * 8.1, and will fail with lslboost::asio::error::operation_not_supported on
   * these platforms.
   */
  ...
  native_handle_type release()
  {
    ...
    lslboost::asio::detail::throw_error(ec, "release");
    return s;
  }
  ...
  __declspec(deprecated("This function always fails with "
        ...
        "prior to Windows 8.1."))
#endif
  native_handle_type release(lslboost::system::error_code& ec)
  {
   ...
   * lslboost::asio::ip::tcp::acceptor acceptor(io_context);
   * ...
   * acceptor.wait(lslboost::asio::ip::tcp::acceptor::wait_read);
   * @endcode
   */
   ...
   * ...
   * lslboost::system::error_code ec;
   * acceptor.wait(lslboost::asio::ip::tcp::acceptor::wait_read, ec);
   * @endcode
   */
   ...
   * ...
   * acceptor.async_wait(
   *     lslboost::asio::ip::tcp::acceptor::wait_read,
   *     wait_handler);
   * @endcode
   */
  ...
  template <typename Protocol1>
  BOOST_ASIO_SYNC_OP_VOID accept(
      basic_socket<Protocol1>& peer, lslboost::system::error_code& ec,
      typename enable_if<is_convertible<Protocol, Protocol1>::value>::type* = 0)
#endif // defined(BOOST_ASIO_ENABLE_OLD_SERVICES)
  {
    this->get_service().accept(this->get_implementation(),
   ...
   * lslboost::asio::ip::tcp::acceptor acceptor(io_context);
   * ...
   * lslboost::asio::ip::tcp::socket socket(acceptor.accept());
   * @endcode
   */
   ...
   * lslboost::asio::ip::tcp::acceptor acceptor(io_context);
   * ...
   * lslboost::asio::ip::tcp::socket socket(acceptor.accept(ec));
   * if (ec)
   * {
   *   // An error occurred.
   * }
   * @endcode
   */
  typename Protocol::socket accept(lslboost::system::error_code& ec)
  {
   ...
   * @code
   * void accept_handler(const lslboost::system::error_code& error,
   *     lslboost::asio::ip::tcp::socket peer)
   * {
   *   if (!error)
   *   {
   *     // Accept succeeded.
  ...
  BOOST_ASIO_INITFN_RESULT_TYPE(MoveAcceptHandler,
      void (lslboost::system::error_code, typename Protocol::socket))
  async_accept(BOOST_ASIO_MOVE_ARG(MoveAcceptHandler) handler)
  {
    ...
    return this->get_service().async_accept(
        this->get_implementation(), static_cast<lslboost::asio::io_context*>(0),
   ...
   * @endcode
   */
  typename Protocol::socket accept(lslboost::asio::io_context& io_context)
  {
    lslboost::system::error_code ec;
    typename Protocol::socket peer(
        this->get_service().accept(this->get_implementation(),
   ...
   * lslboost::asio::ip::tcp::acceptor acceptor(io_context);
   * ...
   * lslboost::asio::ip::tcp::socket socket(acceptor.accept(io_context2, ec));
   * if (ec)
   * {
   *   // An error occurred.
   * }
   ...
   */
  typename Protocol::socket accept(
      lslboost::asio::io_context& io_context, lslboost::system::error_code& ec)
  {
  ...
  BOOST_ASIO_INITFN_RESULT_TYPE(MoveAcceptHandler,
      void (lslboost::system::error_code, typename Protocol::socket))
  async_accept(lslboost::asio::io_context& io_context,
   ...
   * ...
   * lslboost::asio::ip::tcp::endpoint endpoint;
   * lslboost::asio::ip::tcp::socket socket(acceptor.accept(endpoint));
   * @endcode
   */
  typename Protocol::socket accept(endpoint_type& peer_endpoint)
  {
    ...
    typename Protocol::socket peer(
        this->get_service().accept(this->get_implementation(),
          static_cast<lslboost::asio::io_context*>(0), &peer_endpoint, ec));
    lslboost::asio::detail::throw_error(ec, "accept");
    return peer;
  }
   ...
   * ...
   * lslboost::asio::ip::tcp::endpoint endpoint;
   * lslboost::asio::ip::tcp::socket socket(acceptor.accept(endpoint, ec));
   * if (ec)
   * {
   *   // An error occurred.
   * }
...
#if defined(BOOST_ASIO_ENABLE_OLD_SERVICES)
    return this->get_service().async_accept(this->get_implementation(),
        static_cast<lslboost::asio::io_context*>(0), &peer_endpoint,
        BOOST_ASIO_MOVE_CAST(MoveAcceptHandler)(handler));
#else // defined(BOOST_ASIO_ENABLE_OLD_SERVICES)
    async_completion<MoveAcceptHandler,
      void (lslboost::system::error_code,
   ...
   * ...
   * lslboost::asio::ip::tcp::endpoint endpoint;
   * lslboost::asio::ip::tcp::socket socket(
   *     acceptor.accept(io_context2, endpoint));
   * @endcode
   */
  typename Protocol::socket accept(
      lslboost::asio::io_context& io_context, endpoint_type& peer_endpoint)
  {
    lslboost::system::error_code ec;
    typename Protocol::socket peer(
        this->get_service().accept(this->get_implementation(),

 ...
 * @code
 * lslboost::asio::ip::tcp::acceptor acceptor(my_context);
...
public:
   ...
   * lslboost::asio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * lslboost::asio::ip::tcp::socket socket(my_context);
  ...
  BOOST_ASIO_SYNC_OP_VOID accept(
      basic_socket<Protocol1, Executor1>& peer, lslboost::system::error_code& ec,
      typename enable_if<
        is_convertible<Protocol, Protocol1>::value
      >::type* = 0)
  {
  ...
  async_accept(basic_socket<Protocol1, Executor1>& peer,
      ...
      >::type* = 0)
  {
    return async_initiate<AcceptHandler, void (lslboost::system::error_code)>(
   ...
   */
  typename Protocol::socket::template rebind_executor<executor_type>::other
  accept(lslboost::system::error_code& ec)
  {
    typename Protocol::socket::template rebind_executor<
      executor_type>::other peer(impl_.get_executor());
    impl_.get_service().accept(impl_.get_implementation(), peer, 0, ec);
        ...
        BOOST_ASIO_DEFAULT_COMPLETION_TOKEN(executor_type))
  {
    return async_initiate<MoveAcceptHandler,
      void (lslboost::system::error_code, typename Protocol::socket::template
        rebind_executor<executor_type>::other)>(
   ...
   * lslboost::asio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * lslboost::asio::ip::tcp::socket socket(acceptor.accept(my_context2, ec));
   * if (ec)
   * {
   *   // An error occurred.
   * }
  ...
  template <typename Executor1>
  typename Protocol::socket::template rebind_executor<Executor1>::other
  accept(const Executor1& ex, lslboost::system::error_code& ec,
      typename enable_if<
        is_executor<Executor1>::value
          || execution::is_executor<Executor1>::value
      >::type* = 0)
  ...
  typename Protocol::socket::template rebind_executor<
      typename ExecutionContext::executor_type>::other
  accept(ExecutionContext& context, lslboost::system::error_code& ec,
      typename enable_if<
        is_convertible<ExecutionContext&, execution_context&>::value
      >::type* = 0)
  {
      ...
      >::type* = 0)
  {
    ...
    return async_initiate<MoveAcceptHandler,
      void (lslboost::system::error_code, other_socket_type)>(
        initiate_async_move_accept(this), handler,
   ...
   */
  typename Protocol::socket::template rebind_executor<executor_type>::other
  accept(endpoint_type& peer_endpoint, lslboost::system::error_code& ec)
  {
    typename Protocol::socket::template rebind_executor<
      executor_type>::other peer(impl_.get_executor());
    impl_.get_service().accept(impl_.get_implementation(),

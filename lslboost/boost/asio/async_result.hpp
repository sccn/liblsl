...
#define BOOST_ASIO_COMPLETION_SIGNATURE \
  ::lslboost::asio::completion_signature
...
#define BOOST_ASIO_COMPLETION_HANDLER_FOR(s) \
  ::lslboost::asio::completion_handler_for<s>
...
struct async_completion
{
  ...
  typedef typename lslboost::asio::async_result<
...
# define BOOST_ASIO_INITFN_RESULT_TYPE(ct, sig) \
  typename ::lslboost::asio::detail::async_result_helper< \
    ct, sig>::return_type
...
# define BOOST_ASIO_INITFN_RESULT_TYPE(ct, sig) \
  typename ::lslboost::asio::async_result< \
    typename ::lslboost::asio::decay<ct>::type, sig>::return_type
#define BOOST_ASIO_HANDLER_TYPE(ct, sig) \
  typename ::lslboost::asio::async_result< \
    typename ::lslboost::asio::decay<ct>::type, sig>::completion_handler_type
#endif
...
#define BOOST_ASIO_COMPLETION_TOKEN_FOR(s) \
  ::lslboost::asio::completion_token_for<s>
...
#define BOOST_ASIO_DEFAULT_COMPLETION_TOKEN_TYPE(e) \
  = typename ::lslboost::asio::default_completion_token<e>::type

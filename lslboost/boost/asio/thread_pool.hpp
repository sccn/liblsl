 ...
 *
 * To submit functions to the thread pool, use the @ref lslboost::asio::dispatch,
...
public:
   ...
   * lslboost::asio::require customisation point.
   *
   * For example:
   * @code auto ex1 = my_thread_pool.executor();
   * auto ex2 = lslboost::asio::require(ex1,
   *     lslboost::asio::execution::blocking.possibly); @endcode
   */
   ...
   * @code auto ex1 = my_thread_pool.executor();
   * auto ex2 = lslboost::asio::require(ex1,
   *     lslboost::asio::execution::blocking.always); @endcode
   */
  BOOST_ASIO_CONSTEXPR basic_executor_type<Allocator,
   ...
   * @code auto ex1 = my_thread_pool.executor();
   * auto ex2 = lslboost::asio::require(ex1,
   *     lslboost::asio::execution::blocking.never); @endcode
   */
  BOOST_ASIO_CONSTEXPR basic_executor_type<Allocator,
      BOOST_ASIO_UNSPECIFIED(Bits & ~blocking_mask)>
   ...
   * @code auto ex1 = my_thread_pool.executor();
   * auto ex2 = lslboost::asio::require(ex1,
   *     lslboost::asio::execution::relationship.fork); @endcode
   */
   ...
   * @code auto ex1 = my_thread_pool.executor();
   * auto ex2 = lslboost::asio::require(ex1,
   *     lslboost::asio::execution::relationship.continuation); @endcode
   */
  BOOST_ASIO_CONSTEXPR basic_executor_type require(
   ...
   * @code auto ex1 = my_thread_pool.executor();
   * auto ex2 = lslboost::asio::require(ex1,
   *     lslboost::asio::execution::outstanding_work.tracked); @endcode
   */
  BOOST_ASIO_CONSTEXPR basic_executor_type<Allocator,
   ...
   * @code auto ex1 = my_thread_pool.executor();
   * auto ex2 = lslboost::asio::require(ex1,
   *     lslboost::asio::execution::outstanding_work.untracked); @endcode
   */
  BOOST_ASIO_CONSTEXPR basic_executor_type<Allocator,
      BOOST_ASIO_UNSPECIFIED(Bits & ~outstanding_work_tracked)>
   ...
   * @code auto ex1 = my_thread_pool.executor();
   * auto ex2 = lslboost::asio::require(ex1,
   *     lslboost::asio::execution::allocator(my_allocator)); @endcode
   */
   ...
   * @code auto ex1 = my_thread_pool.executor();
   * auto ex2 = lslboost::asio::require(ex1,
   *     lslboost::asio::execution::allocator); @endcode
   */
  ...
  /**
   * Do not call this function directly. It is intended for use with the
   * lslboost::asio::query customisation point.
   *
   * For example:
   * @code auto ex = my_thread_pool.executor();
   * if (lslboost::asio::query(ex, lslboost::asio::execution::bulk_guarantee)
   *       == lslboost::asio::execution::bulk_guarantee.parallel)
   *   ... @endcode
   */
   ...
   * For example:
   * @code auto ex = my_thread_pool.executor();
   * if (lslboost::asio::query(ex, lslboost::asio::execution::mapping)
   *       == lslboost::asio::execution::mapping.thread)
   *   ... @endcode
   */
   ...
   * For example:
   * @code auto ex = my_thread_pool.executor();
   * lslboost::asio::thread_pool& pool = lslboost::asio::query(
   *     ex, lslboost::asio::execution::context); @endcode
   */
   ...
   * For example:
   * @code auto ex = my_thread_pool.executor();
   * if (lslboost::asio::query(ex, lslboost::asio::execution::blocking)
   *       == lslboost::asio::execution::blocking.always)
   *   ... @endcode
   */
   ...
   * For example:
   * @code auto ex = my_thread_pool.executor();
   * if (lslboost::asio::query(ex, lslboost::asio::execution::relationship)
   *       == lslboost::asio::execution::relationship.continuation)
   *   ... @endcode
   */
   ...
   * For example:
   * @code auto ex = my_thread_pool.executor();
   * if (lslboost::asio::query(ex, lslboost::asio::execution::outstanding_work)
   *       == lslboost::asio::execution::outstanding_work.tracked)
   *   ... @endcode
   */
   ...
   * For example:
   * @code auto ex = my_thread_pool.executor();
   * auto alloc = lslboost::asio::query(ex,
   *     lslboost::asio::execution::allocator); @endcode
   */
  template <typename OtherAllocator>
   ...
   * For example:
   * @code auto ex = my_thread_pool.executor();
   * std::size_t occupancy = lslboost::asio::query(
   *     ex, lslboost::asio::execution::occupancy); @endcode
   */
...
struct equality_comparable<
    lslboost::asio::thread_pool::basic_executor_type<Allocator, Bits>
  >
{
...
struct schedule_member<
    const lslboost::asio::thread_pool::basic_executor_type<Allocator, Bits>
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef lslboost::asio::thread_pool::basic_executor_type<
  ...
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef lslboost::asio::execution::detail::as_operation<
      lslboost::asio::thread_pool::basic_executor_type<Allocator, Bits>,
...
struct require_member<
    lslboost::asio::thread_pool::basic_executor_type<Allocator, Bits>,
    lslboost::asio::execution::blocking_t::possibly_t
  > : lslboost::asio::detail::thread_pool_bits
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef lslboost::asio::thread_pool::basic_executor_type<
...
struct require_member<
    lslboost::asio::thread_pool::basic_executor_type<Allocator, Bits>,
    lslboost::asio::execution::blocking_t::always_t
  > : lslboost::asio::detail::thread_pool_bits
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef lslboost::asio::thread_pool::basic_executor_type<Allocator,
...
struct require_member<
    lslboost::asio::thread_pool::basic_executor_type<Allocator, Bits>,
    lslboost::asio::execution::blocking_t::never_t
  > : lslboost::asio::detail::thread_pool_bits
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
...
struct require_member<
    lslboost::asio::thread_pool::basic_executor_type<Allocator, Bits>,
    lslboost::asio::execution::relationship_t::fork_t
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
...
struct require_member<
    lslboost::asio::thread_pool::basic_executor_type<Allocator, Bits>,
    lslboost::asio::execution::relationship_t::continuation_t
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
...
struct require_member<
    lslboost::asio::thread_pool::basic_executor_type<Allocator, Bits>,
    lslboost::asio::execution::outstanding_work_t::tracked_t
  > : lslboost::asio::detail::thread_pool_bits
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
...
struct require_member<
    lslboost::asio::thread_pool::basic_executor_type<Allocator, Bits>,
    lslboost::asio::execution::outstanding_work_t::untracked_t
  > : lslboost::asio::detail::thread_pool_bits
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
...
struct require_member<
    lslboost::asio::thread_pool::basic_executor_type<Allocator, Bits>,
    lslboost::asio::execution::allocator_t<void>
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
...
struct require_member<
    lslboost::asio::thread_pool::basic_executor_type<Allocator, Bits>,
    lslboost::asio::execution::allocator_t<OtherAllocator>
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
...
struct query_static_constexpr_member<
    ...
    typename lslboost::asio::enable_if<
      lslboost::asio::is_convertible<
        Property,
        lslboost::asio::execution::bulk_guarantee_t
      >::value
    >::type
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef lslboost::asio::execution::bulk_guarantee_t::parallel_t result_type;
...
struct query_static_constexpr_member<
    ...
    typename lslboost::asio::enable_if<
      lslboost::asio::is_convertible<
        Property,
        lslboost::asio::execution::outstanding_work_t
      >::value
    >::type
  > : lslboost::asio::detail::thread_pool_bits
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef lslboost::asio::execution::outstanding_work_t result_type;
...
struct query_static_constexpr_member<
    ...
    typename lslboost::asio::enable_if<
      lslboost::asio::is_convertible<
        Property,
        lslboost::asio::execution::mapping_t
      >::value
    >::type
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef lslboost::asio::execution::mapping_t::thread_t result_type;
  ...
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef lslboost::asio::execution::blocking_t result_type;
};
...
struct query_member<
    ...
    typename lslboost::asio::enable_if<
      lslboost::asio::is_convertible<
        Property,
        lslboost::asio::execution::relationship_t
      >::value
    >::type
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef lslboost::asio::execution::relationship_t result_type;
};

template <typename Allocator, unsigned int Bits>
struct query_member<
    lslboost::asio::thread_pool::basic_executor_type<Allocator, Bits>,
    lslboost::asio::execution::occupancy_t
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
...
struct query_member<
    lslboost::asio::thread_pool::basic_executor_type<Allocator, Bits>,
    lslboost::asio::execution::context_t
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef lslboost::asio::thread_pool& result_type;
};

...
struct blocking_t
{
  ...
  {
    return lslboost::asio::query(ex, possibly_t());
  }
...
#endif // !defined(__clang__)
  {
    return lslboost::asio::query(ex, always_t());
  }
...
#endif // !defined(__clang__)
  {
    return lslboost::asio::query(ex, never_t());
  }
...
public:
  ...
  {
    return lslboost::asio::require(executor_, possibly_t<I>());
  }
  ...
  {
    return lslboost::asio::require(executor_, never_t<I>());
  }
      ...
      is_nothrow_require<const Executor&, Property>::value))
  {
    return adapter<typename decay<
      typename require_result<const Executor&, Property>::type
        >::type>(0, lslboost::asio::require(executor_, p));
  }
      ...
      is_nothrow_prefer<const Executor&, Property>::value))
  {
    return adapter<typename decay<
      typename prefer_result<const Executor&, Property>::type
        >::type>(0, lslboost::asio::prefer(executor_, p));
  }

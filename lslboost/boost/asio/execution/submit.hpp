...
using lslboost::asio::traits::submit_free;
using lslboost::asio::traits::submit_member;
...
struct impl
{
  ...
  operator()(S&& s, R&& r) const
    BOOST_ASIO_NOEXCEPT_IF((
      call_traits<S, void(R)>::is_noexcept))
  {
    return lslboost::asio::execution::start(
        (new lslboost::asio::execution::detail::submit_receiver<S, R>(
  ...
  {
    return lslboost::asio::execution::start(
        (new lslboost::asio::execution::detail::submit_receiver<
          S&, R&>(s, r))->state_);
  }

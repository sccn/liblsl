...
public:
   ...
   * lslboost::asio::require and lslboost::asio::prefer customisation points.
   *
   * For example:
   * @code execution::any_executor<execution::blocking_t::possibly_t> ex = ...;
   * auto ex2 = lslboost::asio::requre(ex, execution::blocking.possibly); @endcode
   */
  ...
  /**
   * Do not call this function directly. It is intended for use with the
   * lslboost::asio::prefer customisation point.
   *
   * For example:
   * @code execution::any_executor<execution::blocking_t::possibly_t> ex = ...;
   * auto ex2 = lslboost::asio::prefer(ex, execution::blocking.possibly); @endcode
   */
  template <typename Property>
   ...
   * size_t n = lslboost::asio::query(ex, execution::occupancy); @endcode
   */
  template <typename Property>
   ...
   *
   * Throws lslboost::asio::bad_executor if the polymorphic wrapper has no target.
   */
...
public:
  ...
  any_executor_base(Executor other, true_type)
    : object_fns_(object_fns_table<lslboost::asio::detail::shared_ptr<void> >()),
      target_fns_(other.target_fns_)
  {
    lslboost::asio::detail::shared_ptr<Executor> p =
      lslboost::asio::detail::make_shared<Executor>(
          BOOST_ASIO_MOVE_CAST(Executor)(other));
    target_ = p->template target<void>();
    new (&object_) lslboost::asio::detail::shared_ptr<void>(
        BOOST_ASIO_MOVE_CAST(lslboost::asio::detail::shared_ptr<Executor>)(p));
  }
  ...
  void execute(BOOST_ASIO_MOVE_ARG(F) f) const
  {
    ...
    {
      lslboost::asio::detail::non_const_lvalue<F> f2(f);
...
protected:
  ...
  {
    typedef lslboost::asio::detail::shared_ptr<void> type;
    ex.object<type>().~type();
  }
  ...
  static const object_fns* object_fns_table(
      typename enable_if<
        is_same<Obj, lslboost::asio::detail::shared_ptr<void> >::value
      >::type* = 0)
  {
    static const object_fns fns =
    {
  ...
  typedef lslboost::asio::detail::executor_function function;
  typedef lslboost::asio::detail::executor_function_view function_view;
...
# pragma warning (disable:4702)
  ...
  static void query_fn_non_void(void*, const void* ex, const void* prop,
      typename enable_if<
        lslboost::asio::can_query<const Ex&, const Prop&>::value
          && is_same<typename Prop::polymorphic_query_result_type, void>::value
      >::type*)
  {
    lslboost::asio::query(*static_cast<const Ex*>(ex),
  ...
  static Poly require_fn_impl(const void* ex, const void* prop,
      ...
      >::type*)
  {
    return lslboost::asio::require(*static_cast<const Ex*>(ex),
        *static_cast<const Prop*>(prop));
  }
  ...
  static Poly prefer_fn_impl(const void* ex, const void* prop,
      ...
      >::type*)
  {
    return lslboost::asio::prefer(*static_cast<const Ex*>(ex),
        *static_cast<const Prop*>(prop));
  }
...
private:
  ...
  {
    return lslboost::asio::query(ex, execution::blocking);
  }
...
//  template <typename...> friend class any_executor;
  ...
  typedef aligned_storage<
      sizeof(lslboost::asio::detail::shared_ptr<void>),
      alignment_of<lslboost::asio::detail::shared_ptr<void> >::value
    >::type object_type;
...
public:
      ...
      >::type* = 0) const
  {
    ...
    prop_fns_[found::index].query(&result, object_fns_->target(*this),
        &static_cast<const typename found::type&>(p));
    return *lslboost::asio::detail::scoped_ptr<
      typename found::query_result_type>(result);
  }

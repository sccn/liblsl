 ...
 *   guarantee <tt>lslboost::asio::query(S, execution::bulk_guarantee)</tt>, and
 ...
 *   progress guarantee <tt>lslboost::asio::query(E,
 ...
 *   if <tt>lslboost::asio::query(S, execution::bulk_guarantee)</tt> equals
...
using lslboost::asio::execution::bulk_guarantee_t;
using lslboost::asio::execution::detail::bulk_sender;
using lslboost::asio::execution::executor_index;
using lslboost::asio::execution::is_sender;
using lslboost::asio::is_convertible;
using lslboost::asio::is_same;
using lslboost::asio::remove_cvref;
using lslboost::asio::result_of;
using lslboost::asio::traits::bulk_execute_free;
using lslboost::asio::traits::bulk_execute_member;

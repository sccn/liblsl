...
struct as_invocable
{
  ...
  explicit as_invocable(Receiver& r) BOOST_ASIO_NOEXCEPT
    : receiver_(lslboost::asio::detail::addressof(r))
  {
  }
...
{
  Receiver* receiver_;
  lslboost::asio::detail::shared_ptr<lslboost::asio::detail::atomic_count> ref_count_;

  explicit as_invocable(Receiver& r,
      const lslboost::asio::detail::shared_ptr<
        lslboost::asio::detail::atomic_count>& c) BOOST_ASIO_NOEXCEPT
    : receiver_(lslboost::asio::detail::addressof(r)),
      ref_count_(c)
  {
  }

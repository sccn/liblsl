...
template <>
struct set_value_member<lslboost::asio::execution::detail::void_receiver, void()>
{
...
template <typename E>
struct set_error_member<lslboost::asio::execution::detail::void_receiver, E>
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef void result_type;
...
template <>
struct set_done_member<lslboost::asio::execution::detail::void_receiver>
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef void result_type;

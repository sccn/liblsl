...
struct has_sender_traits<S,
    typename enable_if<
      is_same<
        typename lslboost::asio::execution::sender_traits<
...
#define BOOST_ASIO_EXECUTION_SENDER ::lslboost::asio::execution::sender
...
#define BOOST_ASIO_EXECUTION_SENDER_TO(r) \
  ::lslboost::asio::execution::sender_to<r>
...
#define BOOST_ASIO_EXECUTION_TYPED_SENDER \
  ::lslboost::asio::execution::typed_sender

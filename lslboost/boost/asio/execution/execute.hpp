...
using lslboost::asio::execution::detail::as_receiver;
using lslboost::asio::execution::detail::is_as_invocable;
using lslboost::asio::execution::is_sender_to;
using lslboost::asio::false_type;
using lslboost::asio::result_of;
using lslboost::asio::traits::execute_free;
using lslboost::asio::traits::execute_member;
using lslboost::asio::true_type;
...
struct impl
{
  ...
  operator()(
    ...
    BOOST_ASIO_NOEXCEPT_IF((
      call_traits<T, void(F)>::is_noexcept))
  {
    return lslboost::asio::execution::detail::submit_helper(

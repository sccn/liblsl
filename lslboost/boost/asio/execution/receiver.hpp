...
#define BOOST_ASIO_EXECUTION_RECEIVER ::lslboost::asio::execution::receiver
...
#define BOOST_ASIO_EXECUTION_RECEIVER_OF_0 \
  ::lslboost::asio::execution::receiver_of

#define BOOST_ASIO_EXECUTION_RECEIVER_OF_1(v) \
  ::lslboost::asio::execution::receiver_of<v>

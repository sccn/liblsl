 ...
 * execution.
 *
 * @param a The lslboost::asio::awaitable object that is the result of calling the
 ...
 * @par Example
 * @code
 * lslboost::asio::awaitable<std::size_t> echo(tcp::socket socket)
 * {
 ...
 *           lslboost::asio::buffer(data), lslboost::asio::use_awaitable);
 *
 *       co_await lslboost::asio::async_write(socket,
 *           lslboost::asio::buffer(data, n), lslboost::asio::use_awaitable);
 *
 *       bytes_transferred += n;
 *     }
 *   }
 ...
 * // ...
 *
 * lslboost::asio::co_spawn(my_executor,
 ...
 * @par Example
 * @code
 * lslboost::asio::awaitable<void> echo(tcp::socket socket)
 * {
 *   try
 *   {
 *     char data[1024];
 ...
 * // ...
 *
 * lslboost::asio::co_spawn(my_io_context,
 *   echo(std::move(my_tcp_socket)),
 *   [](std::exception_ptr e, std::size_t n)
 *   {
 *     std::cout << "transferred " << n << "\n";
 ...
 * @c lslboost::asio::awaitable<R,E> that will be used as the coroutine's entry
 * point.
 *

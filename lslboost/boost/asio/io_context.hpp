 ...
 * auto work = lslboost::asio::require(io_context.get_executor(),
 ...
 *
 * @code lslboost::asio::io_context io_context;
 * typename lslboost::asio::require_result<
 *     lslboost::asio::io_context::executor_type,
 *     lslboost::asio::exeution::outstanding_work_t::tracked_t>
 *   work = lslboost::asio::require(io_context.get_executor(),
 *     lslboost::asio::execution::outstanding_work.tracked);
 * ... @endcode
 *
 ...
 *
 * @code lslboost::asio::io_context io_context;
 * lslboost::asio::any_io_executor work
 *   = lslboost::asio::require(io_context.get_executor(),
 *       lslboost::asio::execution::outstanding_work.tracked);
 * ... @endcode
 *
 ...
 *       lslboost::asio::execution::outstanding_work.tracked);
 * ...
 * work = lslboost::asio::any_io_executor(); // Allow run() to exit. @endcode
 */
class io_context
...
public:
   ...
   * For example:
   * @code auto ex = my_io_context.get_executor();
   * lslboost::asio::io_context& ctx = lslboost::asio::query(
...
struct equality_comparable<
    lslboost::asio::io_context::basic_executor_type<Allocator, Bits>
  >
{
  ...
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef lslboost::asio::io_context::basic_executor_type<
...
struct require_member<
  ...
  > : lslboost::asio::detail::io_context_bits
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef lslboost::asio::io_context::basic_executor_type<
  ...
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef lslboost::asio::io_context& result_type;
};

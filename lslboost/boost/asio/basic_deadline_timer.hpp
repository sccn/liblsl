 ...
 * lslboost::asio::deadline_timer timer(io_context);
 *
...
public:
   ...
   */
  explicit basic_deadline_timer(lslboost::asio::io_context& io_context)
   ...
   * as an absolute time.
   */
  basic_deadline_timer(lslboost::asio::io_context& io_context,

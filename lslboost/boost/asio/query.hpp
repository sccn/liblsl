 ...
 * expression <tt>lslboost::asio::query(E, P)</tt> for some
 ...
 *   constant expression with value <tt>true</tt>, <tt>lslboost::asio::query(E,
 *   P)</tt> is ill-formed.
 *
 ...
 *
 * @li Otherwise, <tt>lslboost::asio::query(E, P)</tt> is ill-formed.
 */
 ...
 * @c true_type if the expression <tt>lslboost::asio::query(std::declval<T>(),
 ...
 * type of the expression <tt>lslboost::asio::query(std::declval<T>(),
...
using lslboost::asio::traits::query_free;
using lslboost::asio::traits::query_member;
using lslboost::asio::traits::static_query;

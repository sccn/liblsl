 ...
 * std::string n = lslboost::asio::read_until(s,
 *     lslboost::asio::dynamic_buffer(data), '\n');
...
std::size_t read_until(SyncReadStream& s,
    ...
    char delim, lslboost::system::error_code& ec);
 ...
 * @code std::string data;
 * std::string n = lslboost::asio::read_until(s,
 *     lslboost::asio::dynamic_buffer(data), lslboost::regex("\r\n"));
 * std::string line = data.substr(0, n);
 * data.erase(0, n); @endcode
 * After the @c read_until operation completes successfully, the string @c data
 * contains the delimiter:
...
std::size_t read_until(SyncReadStream& s,
    BOOST_ASIO_MOVE_ARG(DynamicBuffer) buffers,
    const lslboost::regex& expr, lslboost::system::error_code& ec);
 ...
 *     lslboost::asio::const_buffers_1> iterator;
 *
 ...
 * ...
 * std::string data;
 * lslboost::asio::read_until(s, data, match_whitespace);
 * @endcode
 *
 ...
 * ...
 * std::string data;
 * lslboost::asio::read_until(s, data, match_char('a'));
 * @endcode
 */
...
std::size_t read_until(SyncReadStream& s,
    lslboost::asio::basic_streambuf<Allocator>& b,
    BOOST_ASIO_STRING_VIEW_PARAM delim, lslboost::system::error_code& ec);
 ...
 * }
 * ...
 * lslboost::asio::async_read_until(s, data, '\n', handler); @endcode
 ...
 * ...
 * std::string data;
 * lslboost::asio::async_read_until(s, data, match_whitespace, handler);
 * @endcode
 *
 ...
 * ...
 * std::string data;
 * lslboost::asio::async_read_until(s, data, match_char('a'), handler);
 * @endcode
 */

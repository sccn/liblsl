 ...
 * @c lslboost::asio::detached. For example:

 * @code my_socket.async_send(my_buffer, lslboost::asio::detached);
 * @endcode
 */
class detached_t
{
...
/**
 * See the documentation for lslboost::asio::detached_t for a usage example.
 */

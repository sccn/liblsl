...
public:
...
#endif // defined(__GNUC__) && (__GNUC__ == 4) && (__GNUC_MINOR__ == 3)
  {
    ...
    new_iter.begin_ = lslboost::asio::buffer_sequence_begin(buffers);
    new_iter.current_ = lslboost::asio::buffer_sequence_begin(buffers);
    new_iter.end_ = lslboost::asio::buffer_sequence_end(buffers);

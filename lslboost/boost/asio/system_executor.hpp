...
public:
   ...
   *
   * For example:
   * @code lslboost::asio::system_executor ex1;
   ...
   *
   * For example:
   * @code lslboost::asio::system_executor ex;
   ...
   * For example:
   * @code lslboost::asio::system_executor ex;
   * lslboost::asio::system_context& pool = lslboost::asio::query(
...
struct equality_comparable<
    lslboost::asio::basic_system_executor<Blocking, Relationship, Allocator>
  >
{
  ...
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef lslboost::asio::basic_system_executor<
      lslboost::asio::execution::blocking_t::possibly_t,
  ...
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef lslboost::asio::basic_system_executor<Blocking,
      lslboost::asio::execution::relationship_t::fork_t,
  ...
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef lslboost::asio::system_context& result_type;
};
...
struct query_member<
    lslboost::asio::basic_system_executor<Blocking, Relationship, Allocator>,
    lslboost::asio::execution::allocator_t<Allocator>
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);

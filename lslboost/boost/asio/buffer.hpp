...
/** @defgroup buffer_sequence_begin lslboost::asio::buffer_sequence_begin
 *
 * @brief The lslboost::asio::buffer_sequence_begin function returns an iterator
...
/** @defgroup buffer_sequence_end lslboost::asio::buffer_sequence_end
 *
 * @brief The lslboost::asio::buffer_sequence_end function returns an iterator
 ...
 * auto i = lslboost::asio::buffer_sequence_begin(buffers);
 * auto end = lslboost::asio::buffer_sequence_end(buffers);
 * for (; i != end; ++i)
 * {
 *   const_buffer b(*i);
 *   total_size += b.size();
...
inline std::size_t buffer_size(const BufferSequence& b) BOOST_ASIO_NOEXCEPT
{
  return detail::buffer_size(
      ...
      lslboost::asio::buffer_sequence_begin(b),
      lslboost::asio::buffer_sequence_end(b));
}
 ...
 * lslboost::asio::buffer_cast function is used to obtain a pointer to the
...
buffer(lslboost::array<PodType, N>& data) BOOST_ASIO_NOEXCEPT
{
...
template <typename PodType, std::size_t N>
inline BOOST_ASIO_MUTABLE_BUFFER buffer(
    lslboost::array<PodType, N>& data) BOOST_ASIO_NOEXCEPT
{
  return BOOST_ASIO_MUTABLE_BUFFER(
 ...
 */
template <typename PodType, std::size_t N>
inline BOOST_ASIO_MUTABLE_BUFFER buffer(lslboost::array<PodType, N>& data,
    std::size_t max_size_in_bytes) BOOST_ASIO_NOEXCEPT
{
...
template <typename PodType, std::size_t N>
inline BOOST_ASIO_CONST_BUFFER buffer(
    lslboost::array<const PodType, N>& data) BOOST_ASIO_NOEXCEPT
{
 ...
 */
template <typename PodType, std::size_t N>
inline BOOST_ASIO_CONST_BUFFER buffer(lslboost::array<const PodType, N>& data,
    std::size_t max_size_in_bytes) BOOST_ASIO_NOEXCEPT
{
...
template <typename PodType, std::size_t N>
inline BOOST_ASIO_CONST_BUFFER buffer(
    const lslboost::array<PodType, N>& data) BOOST_ASIO_NOEXCEPT
{
  return BOOST_ASIO_CONST_BUFFER(data.data(), data.size() * sizeof(PodType));
}
 ...
 */
template <typename PodType, std::size_t N>
inline BOOST_ASIO_CONST_BUFFER buffer(const lslboost::array<PodType, N>& data,
    std::size_t max_size_in_bytes) BOOST_ASIO_NOEXCEPT
{
  return BOOST_ASIO_CONST_BUFFER(data.data(),
      data.size() * sizeof(PodType) < max_size_in_bytes
...
public:
  ...
  {
    return const_buffers_type(lslboost::asio::buffer(string_, size_));
  }
#endif // !defined(BOOST_ASIO_NO_DYNAMIC_BUFFER_V1)
  ...
  {
    return mutable_buffers_type(lslboost::asio::buffer(
          lslboost::asio::buffer(string_, max_size_) + pos, n));
  }
  ...
  {
    return const_buffers_type(lslboost::asio::buffer(
          lslboost::asio::buffer(string_, max_size_) + pos, n));
  }
  ...
  mutable_buffers_type prepare(std::size_t n)
  {
    ...
    return lslboost::asio::buffer(lslboost::asio::buffer(string_) + size_, n);
  }
...
public:
  ...
  const_buffers_type data() const BOOST_ASIO_NOEXCEPT
  {
    return const_buffers_type(lslboost::asio::buffer(vector_, size_));
  }
#endif // !defined(BOOST_ASIO_NO_DYNAMIC_BUFFER_V1)
  ...
  {
    return mutable_buffers_type(lslboost::asio::buffer(
          lslboost::asio::buffer(vector_, max_size_) + pos, n));
  }
  ...
  mutable_buffers_type prepare(std::size_t n)
  {
    ...
    return lslboost::asio::buffer(lslboost::asio::buffer(vector_) + size_, n);
  }
...
/** @defgroup dynamic_buffer lslboost::asio::dynamic_buffer
 *
 * @brief The lslboost::asio::dynamic_buffer function is used to create a
    ...
    std::size_t max_bytes_to_copy) BOOST_ASIO_NOEXCEPT
{
  return (buffer_copy_1)(*target_begin,
      lslboost::asio::buffer(*source_begin, max_bytes_to_copy));
}
      ...
      = (std::numeric_limits<std::size_t>::max)()) BOOST_ASIO_NOEXCEPT
{
  ...
  for (mutable_buffer target_buffer(
        lslboost::asio::buffer(*target_begin, max_bytes_to_copy));
    ...
    std::size_t max_bytes_to_copy) BOOST_ASIO_NOEXCEPT
{
      ...
      && target_iter != target_end && source_iter != source_end)
  {
    ...
    std::size_t bytes_copied = (buffer_copy_1)(
        target_buffer, lslboost::asio::buffer(source_buffer,
    ...
    const ConstBufferSequence& source) BOOST_ASIO_NOEXCEPT
{
  return detail::buffer_copy(
      ...
      lslboost::asio::buffer_sequence_begin(target),
      lslboost::asio::buffer_sequence_end(target),
      lslboost::asio::buffer_sequence_begin(source),
      lslboost::asio::buffer_sequence_end(source));
}
    ...
    std::size_t max_bytes_to_copy) BOOST_ASIO_NOEXCEPT
{
  return detail::buffer_copy(
      ...
      lslboost::asio::buffer_sequence_end(target),
      lslboost::asio::buffer_sequence_begin(source),
      lslboost::asio::buffer_sequence_end(source), max_bytes_to_copy);
}
...
struct is_mutable_buffer_sequence
  ...
  : lslboost::asio::detail::is_buffer_sequence<T, mutable_buffer>
...
struct is_const_buffer_sequence
  ...
  : integral_constant<bool, automatically_determined>
#else // defined(GENERATING_DOCUMENTATION)
  : lslboost::asio::detail::is_buffer_sequence<T, const_buffer>
#endif // defined(GENERATING_DOCUMENTATION)
{
};
...
struct is_dynamic_buffer_v1
  ...
  : integral_constant<bool, automatically_determined>
#else // defined(GENERATING_DOCUMENTATION)
  : lslboost::asio::detail::is_dynamic_buffer_v1<T>
#endif // defined(GENERATING_DOCUMENTATION)
{
};
#endif // !defined(BOOST_ASIO_NO_DYNAMIC_BUFFER_V1)
...
struct is_dynamic_buffer_v2
  ...
  : integral_constant<bool, automatically_determined>
#else // defined(GENERATING_DOCUMENTATION)
  : lslboost::asio::detail::is_dynamic_buffer_v2<T>
#endif // defined(GENERATING_DOCUMENTATION)
{
};
...
struct is_dynamic_buffer
  ...
  : lslboost::asio::is_dynamic_buffer_v2<T>
#else // defined(BOOST_ASIO_NO_DYNAMIC_BUFFER_V1)
  : lslboost::asio::is_dynamic_buffer_v1<T>
#endif // defined(BOOST_ASIO_NO_DYNAMIC_BUFFER_V1)
{
};

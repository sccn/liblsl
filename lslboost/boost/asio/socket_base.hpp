...
public:
   ...
   * Setting the option:
   * @code
   * lslboost::asio::ip::udp::socket socket(my_context);
   * ...
   ...
   * lslboost::asio::ip::tcp::socket socket(my_context);
   * ...
   * lslboost::asio::socket_base::out_of_band_inline option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * lslboost::asio::ip::tcp::socket socket(my_context);
   * ...
   * lslboost::asio::socket_base::out_of_band_inline option;
   * socket.get_option(option);

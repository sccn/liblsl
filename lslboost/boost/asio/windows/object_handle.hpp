...
#define BOOST_ASIO_SVC_T lslboost::asio::detail::win_object_handle_service
...
public:
   ...
   */
  explicit object_handle(lslboost::asio::io_context& io_context)
   ...
   */
  object_handle(lslboost::asio::io_context& io_context,
  ...
  {
    lslboost::asio::async_completion<WaitHandler,

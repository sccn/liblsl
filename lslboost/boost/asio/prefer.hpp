 ...
 * expression <tt>lslboost::asio::prefer(E, P0, Pn...)</tt> for some subexpressions
 ...
 *   <tt>lslboost::asio::prefer(E, P0, Pn...)</tt> is ill-formed.
 *
 ...
 *
 * @li Otherwise,
 *   <tt>lslboost::asio::prefer(lslboost::asio::prefer(E, P0), Pn...)</tt>
 *   if <tt>N > 0</tt> and the expression
 *   <tt>lslboost::asio::prefer(lslboost::asio::prefer(E, P0), Pn...)</tt>
 *   is a valid expression.
 *
 * @li Otherwise, <tt>lslboost::asio::prefer(E, P0, Pn...)</tt> is ill-formed.
 */
 ...
 * @c true_type if the expression <tt>lslboost::asio::prefer(std::declval<T>(),
 ...
 * type of the expression <tt>lslboost::asio::prefer(std::declval<T>(),
...
using lslboost::asio::decay;
using lslboost::asio::declval;
using lslboost::asio::enable_if;
using lslboost::asio::is_applicable_property;
using lslboost::asio::traits::prefer_free;
using lslboost::asio::traits::prefer_member;
using lslboost::asio::traits::require_free;
using lslboost::asio::traits::require_member;
using lslboost::asio::traits::static_require;

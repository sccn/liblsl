...
#pragma warning(pop)
            ...
            void lock()
            {
                ...
                if(old_count&lock_flag_value)
                {
                    ...
                    do
                    {
                        unsigned const retval(winapi::WaitForSingleObjectEx(sem, ::lslboost::detail::win32::infinite,0));
...
//                                         sem,::lslboost::detail::win32::infinite)==0);
            ...
            bool timed_lock(::lslboost::system_time const& wait_until)
            {
                ...
                if(old_count&lock_flag_value)
                {
                    ...
                    do
                    {
                        if(winapi::WaitForSingleObjectEx(sem,::lslboost::detail::get_milliseconds_until(wait_until),0)!=0)
                        {

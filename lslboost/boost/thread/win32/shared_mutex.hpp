    ...
    public:
        ...
        bool timed_lock_shared(lslboost::system_time const& wait_until)
        {
            for(;;)
            {
                ...
                unsigned long const res=detail::winapi::WaitForSingleObjectEx(semaphores[unlock_sem],::lslboost::detail::get_milliseconds_until(wait_until), 0);
        ...
        bool timed_lock(lslboost::system_time const& wait_until)
        {
            for(;;)
            {
                ...
                #endif
                unsigned long const wait_res=detail::winapi::WaitForMultipleObjectsEx(2,semaphores,wait_all,::lslboost::detail::get_milliseconds_until(wait_until), 0);

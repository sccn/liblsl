    ...
    public:
        ...
        void lock_shared()
        {
            for(;;)
            {
                ...
                BOOST_VERIFY(winapi::WaitForSingleObjectEx(semaphores[unlock_sem],::lslboost::detail::win32::infinite,0)==0);
            }
        }
    ...
    public:
        ...
        void lock()
        {
            for(;;)
            {
                ...
                #endif
                BOOST_VERIFY(winapi::WaitForMultipleObjectsEx(2,semaphores,wait_all,::lslboost::detail::win32::infinite,0)<2);
            }
        }

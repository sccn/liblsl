...
#define BOOST_THREAD_DO_CONTINUATION \
            ...
            virtual void do_continuation(lslboost::unique_lock<lslboost::mutex>&) = 0;
#endif
            ...
            void wait_internal(lslboost::unique_lock<lslboost::mutex> &lk, bool rethrow=true)
            {
              ...
              waiters.wait(lk, lslboost::bind(&shared_state_base::is_done, lslboost::ref(*this)));
            ...
            bool timed_wait(Duration const& rel_time)
            {
                ...
                do_callback(lock);
                return waiters.timed_wait(lock, rel_time, lslboost::bind(&shared_state_base::is_done, lslboost::ref(*this)));
            }
            ...
            bool timed_wait_until(lslboost::system_time const& target_time)
            {
                ...
                do_callback(lock);
                return waiters.timed_wait(lock, target_time, lslboost::bind(&shared_state_base::is_done, lslboost::ref(*this)));
            }
#endif
#ifdef BOOST_THREAD_USES_CHRONO
            ...
            wait_until(const chrono::time_point<Clock, Duration>& abs_time)
            {
              ...
              do_callback(lock);
              if(!waiters.wait_until(lock, abs_time, lslboost::bind(&shared_state_base::is_done, lslboost::ref(*this))))
              {
...
//              this->is_constructed = true;
            ...
            {
                set_value_deferred(lslboost::move(result_));
//              unique_lock<lslboost::mutex> lk(this->mutex);
//              if (this->has_value(lk))
//                  throw_exception(promise_already_satisfied());
//
...
//              this->is_constructed = true;
        ...
        public:
          ...
          ~future_async_shared_state_base()
          {
            ...
            unique_lock<lslboost::mutex> lk(this->mutex);
            this->waiters.wait(lk, lslboost::bind(&shared_state_base::is_done, lslboost::ref(*this)));
#endif
          }
...
#include <boost/thread/detail/atomic_redef_macros.hpp>
    ...
    public:
...
#if defined  BOOST_NO_CXX11_RVALUE_REFERENCES
        template <class TR>
        typename lslboost::enable_if_c<is_copy_constructible<TR>::value && is_same<R, TR>::value, void>::type
...
#if ! defined  BOOST_NO_CXX11_RVALUE_REFERENCES
            future_->set_value_deferred(lslboost::move(r));
#else
        ...
        void set_exception_deferred(lslboost::exception_ptr p)
        {
            lazy_init();
            if (future_.get()==0)
            {
        ...
        {
          set_exception_deferred(lslboost::copy_exception(ex));
        }

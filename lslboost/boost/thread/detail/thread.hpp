...
//            {}
    ...
    public:
        ...
        explicit thread(F f
        , typename disable_if_c<
        lslboost::thread_detail::is_rv<F>::value // todo as a thread_detail::is_rv
        //lslboost::thread_detail::is_convertible<F&,BOOST_THREAD_RV_REF(F)>::value
            //|| is_same<typename decay<F>::type, thread>::value
           , dummy* >::type=0
        ):
    ...
    public:
        ...
        {
          return do_try_join_until(lslboost::detail::internal_platform_timepoint(t));
        }
...
#if defined BOOST_THREAD_USES_DATETIME
        inline BOOST_SYMBOL_VISIBLE void sleep(::lslboost::xtime const& abs_time)
        {

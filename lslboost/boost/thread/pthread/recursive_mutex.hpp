    ...
    public:
        ...
        recursive_mutex()
        {
            ...
            if(res2)
            {
                ...
                lslboost::throw_exception(thread_resource_error(res2, "lslboost:: recursive_mutex constructor failed in pthread::cond_init"));
            }
            is_locked=false;
            count=0;
#endif
...
#define BOOST_THREAD_DEFINES_RECURSIVE_MUTEX_NATIVE_HANDLE
    ...
    public:
        ...
        recursive_timed_mutex()
        {
            ...
            {
                BOOST_VERIFY(!pthread_mutex_destroy(&m));
                lslboost::throw_exception(thread_resource_error(res2, "lslboost:: recursive_timed_mutex constructor failed in pthread::cond_init"));
            }
            is_locked=false;
            count=0;
#endif

...
#   include <boost/preprocessor/facilities/expand.hpp>
    ...
    // sizeof("static cha lslboost::detail::ctti<T>::s() [with I = 40U, T = ") - 1, sizeof("]") - 1
...
namespace lslboost { namespace typeindex { namespace detail {
    ...
    BOOST_CXX14_CONSTEXPR inline const char* skip_begining_runtime(const char* begin, lslboost::false_type) BOOST_NOEXCEPT {
        return begin;
    }
    ...
    BOOST_CXX14_CONSTEXPR inline int constexpr_strcmp(const char *v1, const char *v2) BOOST_NOEXCEPT {
        ...
        if (lslboost::typeindex::detail::is_constant_string(v1) && lslboost::typeindex::detail::is_constant_string(v2))
            return lslboost::typeindex::detail::constexpr_strcmp_loop(v1, v2);
    ...
    template <unsigned int ArrayLength>
    BOOST_CXX14_CONSTEXPR inline const char* skip_begining_runtime(const char* begin, lslboost::true_type) BOOST_NOEXCEPT {
    ...
    BOOST_CXX14_CONSTEXPR inline const char* skip_begining(const char* begin) BOOST_NOEXCEPT {
        ...
        return skip_begining_runtime<ArrayLength - ctti_skip_size_at_begin>(
            ...
            lslboost::integral_constant<bool, ctti_skip_more_at_runtime>()
        );
    }
...
struct ctti {
    ...
    #else
        lslboost::typeindex::detail::failed_to_get_function_name<T>();
    #endif

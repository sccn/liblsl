...
inline stl_type_index stl_type_index::type_id() BOOST_NOEXCEPT {
    ...
    #  if (defined(__EDG_VERSION__) && __EDG_VERSION__ < 245) \
        ...
        typedef BOOST_DEDUCED_TYPENAME lslboost::conditional<
            lslboost::is_signed<no_cvr_prefinal_t>::value,
            lslboost::make_signed<no_cvr_prefinal_t>,
            lslboost::type_identity<no_cvr_prefinal_t>
...
inline stl_type_index stl_type_index::type_id_with_cvr() BOOST_NOEXCEPT {
    typedef BOOST_DEDUCED_TYPENAME lslboost::conditional<
        lslboost::is_reference<T>::value ||  lslboost::is_const<T>::value || lslboost::is_volatile<T>::value,
        detail::cvr_saver<T>,
        T
    >::type type;

...
template<class T> struct is_endian_reversible: lslboost::integral_constant<bool,
    (lslboost::is_integral<T>::value && !lslboost::is_same<T, bool>::value) || is_scoped_enum<T>::value>
{
};

// is_endian_reversible_inplace

template<class T> struct is_endian_reversible_inplace: lslboost::integral_constant<bool,
    lslboost::is_integral<T>::value || lslboost::is_enum<T>::value || lslboost::is_same<T, float>::value || lslboost::is_same<T, double>::value>
{
};

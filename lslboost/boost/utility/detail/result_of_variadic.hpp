...
struct tr1_result_of<F(Args...)>
    : conditional<
        ...
        , lslboost::detail::tr1_result_of_impl<
            ...
            (lslboost::detail::result_of_has_result_type<F>::value)>
        , lslboost::detail::tr1_result_of_impl<
            F,
            F(Args...),
            (lslboost::detail::result_of_has_result_type<F>::value)> >::type { };
...
struct result_of_is_callable {
    ...
    static const bool value = (
        sizeof(result_of_no_type) == sizeof(detail::result_of_is_private_type(
            (lslboost::declval<wrapper_t>()(lslboost::declval<Args>()...), result_of_weird_type())
        ))
    );

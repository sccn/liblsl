...
public:
    ...
    template <class T>
    BOOST_CXX14_CONSTEXPR typename lslboost::enable_if_c<rational_detail::is_compatible_integer<T, IntType>::value, rational&>::type operator+= (const T& i)
    {
       num += i * den;
       return *this;
    }
...
#pragma parse_mfunc_templ reset
    ...
    template <class T>
    BOOST_CXX14_CONSTEXPR typename lslboost::enable_if_c<rational_detail::is_compatible_integer<T, IntType>::value, bool>::type operator< (const T& i) const
    {
       // Avoid repeated construction

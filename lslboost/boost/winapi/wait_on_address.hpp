...
lslboost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
WaitOnAddress(
...
lslboost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
WakeByAddressSingle(lslboost::winapi::PVOID_ addr);

lslboost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
WakeByAddressAll(lslboost::winapi::PVOID_ addr);

...
BOOST_WINAPI_IMPORT_EXCEPT_WM lslboost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
InitializeCriticalSection(lslboost::winapi::detail::winsdk_critical_section* lpCriticalSection);
#endif

BOOST_WINAPI_IMPORT_EXCEPT_WM lslboost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
EnterCriticalSection(lslboost::winapi::detail::winsdk_critical_section* lpCriticalSection);

BOOST_WINAPI_IMPORT_EXCEPT_WM lslboost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
LeaveCriticalSection(lslboost::winapi::detail::winsdk_critical_section* lpCriticalSection);

#if BOOST_USE_WINAPI_VERSION >= 0x0403
#if BOOST_WINAPI_PARTITION_APP_SYSTEM
BOOST_WINAPI_IMPORT lslboost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
InitializeCriticalSectionAndSpinCount(
    lslboost::winapi::detail::winsdk_critical_section* lpCriticalSection,
    lslboost::winapi::DWORD_ dwSpinCount);
...
InitializeCriticalSectionEx(
    lslboost::winapi::detail::winsdk_critical_section* lpCriticalSection,
    lslboost::winapi::DWORD_ dwSpinCount,
    lslboost::winapi::DWORD_ Flags);
#endif
#endif

#if BOOST_USE_WINAPI_VERSION >= BOOST_WINAPI_VERSION_NT4
BOOST_WINAPI_IMPORT_EXCEPT_WM lslboost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
TryEnterCriticalSection(lslboost::winapi::detail::winsdk_critical_section* lpCriticalSection);
#endif

BOOST_WINAPI_IMPORT_EXCEPT_WM lslboost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
DeleteCriticalSection(lslboost::winapi::detail::winsdk_critical_section* lpCriticalSection);

#else // defined( BOOST_WINAPI_IS_MINGW )

BOOST_WINAPI_IMPORT_EXCEPT_WM lslboost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
InitializeCriticalSection(lslboost::winapi::detail::winapi_critical_section* lpCriticalSection);

BOOST_WINAPI_IMPORT_EXCEPT_WM lslboost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
EnterCriticalSection(lslboost::winapi::detail::winapi_critical_section* lpCriticalSection);

BOOST_WINAPI_IMPORT_EXCEPT_WM lslboost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
LeaveCriticalSection(lslboost::winapi::detail::winapi_critical_section* lpCriticalSection);

#if BOOST_USE_WINAPI_VERSION >= 0x0403
BOOST_WINAPI_IMPORT lslboost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
InitializeCriticalSectionAndSpinCount(
    lslboost::winapi::detail::winapi_critical_section* lpCriticalSection,
    lslboost::winapi::DWORD_ dwSpinCount);
...
#if BOOST_USE_WINAPI_VERSION >= BOOST_WINAPI_VERSION_NT4
BOOST_WINAPI_IMPORT_EXCEPT_WM lslboost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
TryEnterCriticalSection(lslboost::winapi::detail::winapi_critical_section* lpCriticalSection);
#endif

BOOST_WINAPI_IMPORT_EXCEPT_WM lslboost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
DeleteCriticalSection(lslboost::winapi::detail::winapi_critical_section* lpCriticalSection);

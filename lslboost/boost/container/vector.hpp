...
class vector
{
   ...
   typedef typename lslboost::container::allocator_traits<Allocator>::size_type  alloc_size_type;
   ...
   typedef typename dtl::version<Allocator>::type alloc_version;
   typedef lslboost::container::vector_alloc_holder<Allocator, stored_size_type> alloc_holder_t;
...
//           ) -> vector<typename iterator_traits<InIt>::value_type, new_allocator<typename iterator_traits<InIt>::value_type>>;
   ...
   dtl::insert_range_proxy<Allocator, lslboost::move_iterator<T*>, T*> priv_dummy_empty_proxy()
   {
      return dtl::insert_range_proxy<Allocator, lslboost::move_iterator<T*>, T*>
   ...
   iterator priv_insert(const const_iterator &p, BOOST_FWD_REF(U) x)
   {
      ...
      return this->priv_forward_range_insert
         ( vector_iterator_get_ptr(p), 1, dtl::get_insert_value_proxy<T*, Allocator>(::lslboost::forward<U>(x)));
   }

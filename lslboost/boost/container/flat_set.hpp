   ...
   ///@endcond
{
   ...
   {  return this->tree_t::emplace_unique(lslboost::forward<Args>(args)...); }
   ...
   {  return this->tree_t::emplace_hint_unique(p, lslboost::forward<Args>(args)...); }
   ...
   //! @copydoc ::lslboost::container::flat_map::merge(flat_map<Key, T, C2, AllocatorOrContainer>&)
   template<class C2>
   BOOST_CONTAINER_FORCEINLINE void merge(flat_set<Key, C2, AllocatorOrContainer>& source)
   {  this->tree_t::merge_unique(source.tree());   }

   //! @copydoc ::lslboost::container::flat_set::merge(flat_set<Key, C2, AllocatorOrContainer>&)
   template<class C2>
   ...
   //! @copydoc ::lslboost::container::flat_map::merge(flat_multimap<Key, T, C2, AllocatorOrContainer>&)
   template<class C2>
   BOOST_CONTAINER_FORCEINLINE void merge(flat_multiset<Key, C2, AllocatorOrContainer>& source)
   {  this->tree_t::merge_unique(source.tree());   }

   //! @copydoc ::lslboost::container::flat_set::merge(flat_multiset<Key, C2, AllocatorOrContainer>&)
   template<class C2>
   ...
   {  this->tree_t::adopt_sequence_unique(lslboost::move(seq));  }
   ...
   {  this->tree_t::adopt_sequence_unique(ordered_unique_range_t(), lslboost::move(seq));  }

   #ifndef BOOST_CONTAINER_DOXYGEN_INVOKED
   private:
   template<class KeyType>
   BOOST_CONTAINER_FORCEINLINE std::pair<iterator, bool> priv_insert(BOOST_FWD_REF(KeyType) x)
   {  return this->tree_t::insert_unique(::lslboost::forward<KeyType>(x));  }

   template<class KeyType>
   BOOST_CONTAINER_FORCEINLINE iterator priv_insert(const_iterator p, BOOST_FWD_REF(KeyType) x)
   {  return this->tree_t::insert_unique(p, ::lslboost::forward<KeyType>(x)); }
   #endif   //#ifndef BOOST_CONTAINER_DOXYGEN_INVOKED
};
...
template <class Key, class Compare, class AllocatorOrContainer>
struct has_trivial_destructor_after_move<lslboost::container::flat_set<Key, Compare, AllocatorOrContainer> >
{
   typedef typename ::lslboost::container::allocator_traits<AllocatorOrContainer>::pointer pointer;
   static const bool value = ::lslboost::has_trivial_destructor_after_move<AllocatorOrContainer>::value &&
   ...
   ///@endcond
{
   ...
   BOOST_CONTAINER_FORCEINLINE flat_multiset(BOOST_RV_REF(flat_multiset) x)
      BOOST_NOEXCEPT_IF(lslboost::container::dtl::is_nothrow_move_constructible<Compare>::value)
      : tree_t(lslboost::move(static_cast<tree_t&>(x)))
   {}
   ...
   {  return this->tree_t::emplace_equal(lslboost::forward<Args>(args)...); }
   ...
   template <class... Args>
   BOOST_CONTAINER_FORCEINLINE iterator emplace_hint(const_iterator p, BOOST_FWD_REF(Args)... args)
   {  return this->tree_t::emplace_hint_equal(p, lslboost::forward<Args>(args)...); }
   ...
   //! @copydoc ::lslboost::container::flat_multimap::merge(flat_multimap<Key, T, C2, AllocatorOrContainer>&)
   template<class C2>
   BOOST_CONTAINER_FORCEINLINE void merge(flat_multiset<Key, C2, AllocatorOrContainer>& source)
   {  this->tree_t::merge_equal(source.tree());   }

   //! @copydoc ::lslboost::container::flat_multiset::merge(flat_multiset<Key, C2, AllocatorOrContainer>&)
   template<class C2>
   BOOST_CONTAINER_FORCEINLINE void merge(BOOST_RV_REF_BEG flat_multiset<Key, C2, AllocatorOrContainer> BOOST_RV_REF_END source)
   {  return this->merge(static_cast<flat_multiset<Key, C2, AllocatorOrContainer>&>(source));   }

   //! @copydoc ::lslboost::container::flat_multimap::merge(flat_map<Key, T, C2, AllocatorOrContainer>&)
   template<class C2>
   BOOST_CONTAINER_FORCEINLINE void merge(flat_set<Key, C2, AllocatorOrContainer>& source)
   {  this->tree_t::merge_equal(source.tree());   }

   //! @copydoc ::lslboost::container::flat_multiset::merge(flat_set<Key, C2, AllocatorOrContainer>&)
   template<class C2>
   BOOST_CONTAINER_FORCEINLINE void merge(BOOST_RV_REF_BEG flat_set<Key, C2, AllocatorOrContainer> BOOST_RV_REF_END source)
   {  return this->merge(static_cast<flat_set<Key, C2, AllocatorOrContainer>&>(source));   }
   ...
   //! @copydoc ::lslboost::container::flat_set::contains(const key_type& ) const
   bool contains(const key_type& x) const;

   //! @copydoc ::lslboost::container::flat_set::contains(const K& ) const
   template<typename K>
   bool contains(const K& x) const;
   ...
   //! <b>Throws</b>: If the comparison or the move constructor throws
   BOOST_CONTAINER_FORCEINLINE void adopt_sequence(BOOST_RV_REF(sequence_type) seq)
   {  this->tree_t::adopt_sequence_equal(lslboost::move(seq));  }
   ...
   {  this->tree_t::adopt_sequence_equal(ordered_range_t(), lslboost::move(seq));  }

   #ifndef BOOST_CONTAINER_DOXYGEN_INVOKED
   private:
   template <class KeyType>
   BOOST_CONTAINER_FORCEINLINE iterator priv_insert(BOOST_FWD_REF(KeyType) x)
   {  return this->tree_t::insert_equal(::lslboost::forward<KeyType>(x));  }

   template <class KeyType>
   BOOST_CONTAINER_FORCEINLINE iterator priv_insert(const_iterator p, BOOST_FWD_REF(KeyType) x)
   {  return this->tree_t::insert_equal(p, ::lslboost::forward<KeyType>(x)); }
   #endif   //#ifndef BOOST_CONTAINER_DOXYGEN_INVOKED
};
...
//!specialization for optimizations
template <class Key, class Compare, class AllocatorOrContainer>
struct has_trivial_destructor_after_move<lslboost::container::flat_multiset<Key, Compare, AllocatorOrContainer> >
{
   typedef typename ::lslboost::container::allocator_traits<AllocatorOrContainer>::pointer pointer;
   static const bool value = ::lslboost::has_trivial_destructor_after_move<AllocatorOrContainer>::value &&
                             ::lslboost::has_trivial_destructor_after_move<pointer>::value &&

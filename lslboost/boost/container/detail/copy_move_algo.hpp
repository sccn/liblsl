...
template <class Pointer, bool IsConst>
struct are_elements_contiguous<lslboost::container::vec_iterator<Pointer, IsConst> >
{
   static const bool value = true;
};
...
struct is_memtransfer_copy_assignable
   : lslboost::move_detail::and_
      ...
      , dtl::is_trivially_copy_assignable< typename ::lslboost::container::iterator_traits<I>::value_type >
      >
{};
...
struct is_memtransfer_copy_constructible
   : lslboost::move_detail::and_
      < are_contiguous_and_same<I, O>
      , dtl::is_trivially_copy_constructible< typename ::lslboost::container::iterator_traits<I>::value_type >
      >
{};
...
BOOST_CONTAINER_FORCEINLINE F memmove(I f, I l, F r) BOOST_NOEXCEPT_OR_NOTHROW
{
   ...
   value_type *const dest_raw = lslboost::movelib::iterator_to_raw_pointer(r);
   const value_type *const beg_raw = lslboost::movelib::iterator_to_raw_pointer(f);
   const value_type *const end_raw = lslboost::movelib::iterator_to_raw_pointer(l);
   if(BOOST_LIKELY(beg_raw != end_raw && dest_raw && beg_raw)){
      const typename lslboost::container::iterator_traits<I>::difference_type n = end_raw - beg_raw;
                    ...
                    , G large_range_f, typename allocator_traits<Allocator>::size_type n_j)
{
   ...
   void *const stora_ptr = static_cast<void*>(lslboost::movelib::iterator_to_raw_pointer(storage.data));
...
{
   typedef typename ::lslboost::container::iterator_traits<Iterator>::value_type value_type;
   ...
   , InsertionProxy insert_range_proxy)
{
   ...
   O d_last = ::lslboost::container::uninitialized_move_alloc(a, first, pos, d_first);
   ...
   (void) ::lslboost::container::uninitialized_move_alloc(a, pos, last, d_last);
   ...
   , InsertionProxy insert_range_proxy)
{
   ...
   if (BOOST_UNLIKELY(!n)){
      ...
      if(elems_after >= n){
         ...
         ::lslboost::container::uninitialized_move_alloc_n(a, last - n, n, last);
         array_destructor_t on_exception(last, last, a);
         //Copy previous to last objects to the initialized end
         lslboost::container::move_backward(pos, last - n, last);
         ...
         F new_last = ::lslboost::container::uninitialized_move_alloc(a, pos, last, pos + n);

...
template<class ...Options>
using tree_assoc_options_t = typename lslboost::container::tree_assoc_options<Options...>::type;
...
//! Helper metafunction to combine options into a single type to be used
//! by \c lslboost::container::hash_set, \c lslboost::container::hash_multiset
//! \c lslboost::container::hash_map and \c lslboost::container::hash_multimap.
//! Supported options are: \c lslboost::container::store_hash
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
template<class O1 = void, class O2 = void, class O3 = void, class O4 = void>
...
template<class ...Options>
using hash_assoc_options_t = typename lslboost::container::hash_assoc_options<Options...>::type;
...
//!\c lslboost::container::growth_factor_50
//!\c lslboost::container::growth_factor_60
//!\c lslboost::container::growth_factor_100
//!
...
//! Helper metafunction to combine options into a single type to be used
//! by \c lslboost::container::vector.
//! Supported options are: \c lslboost::container::growth_factor and \c lslboost::container::stored_size
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
template<class O1 = void, class O2 = void, class O3 = void, class O4 = void>
...
//! Supported options are: \c lslboost::container::growth_factor and \c lslboost::container::stored_size
template<class ...Options>
using vector_options_t = typename lslboost::container::vector_options<Options...>::type;
...
//! Helper metafunction to combine options into a single type to be used
//! by \c lslboost::container::small_vector.
//! Supported options are: \c lslboost::container::growth_factor and \c lslboost::container::inplace_alignment
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
template<class O1 = void, class O2 = void, class O3 = void, class O4 = void>
...
//! Supported options are: \c lslboost::container::growth_factor and \c lslboost::container::stored_size
template<class ...Options>
using small_vector_options_t = typename lslboost::container::small_vector_options<Options...>::type;
...
//! Helper metafunction to combine options into a single type to be used
//! by \c lslboost::container::static_vector.
//! Supported options are: \c lslboost::container::throw_on_overflow and \c lslboost::container::inplace_alignment
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
template<class O1 = void, class O2 = void, class O3 = void, class O4 = void>
...
//! Supported options are: \c lslboost::container::growth_factor and \c lslboost::container::stored_size
template<class ...Options>
using static_vector_options_t = typename lslboost::container::static_vector_options<Options...>::type;

#endif

//! Helper metafunction to combine options into a single type to be used
//! by \c lslboost::container::devector.
//! Supported options are: \c lslboost::container::growth_factor and \c lslboost::container::stored_size
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
...
//! Supported options are: \c lslboost::container::growth_factor and \c lslboost::container::stored_size
template<class ...Options>
using devector_options_t = typename lslboost::container::devector_options<Options...>::type;
...
//! Helper metafunction to combine options into a single type to be used
//! by \c lslboost::container::deque.
//! Supported options are: \c lslboost::container::block_bytes
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
template<class O1 = void, class O2 = void, class O3 = void, class O4 = void>
...
//! Supported options are: \c lslboost::container::block_bytes
template<class ...Options>
using deque_options_t = typename lslboost::container::deque_options<Options...>::type;

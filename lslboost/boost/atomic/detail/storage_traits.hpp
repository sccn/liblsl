...
struct storage_traits< 2u >
{
    ...
    static BOOST_CONSTEXPR_OR_CONST std::size_t native_alignment = atomics::detail::alignment_of< lslboost::uint16_t >::value;
...
struct storage_traits< 4u >
{
    ...
    static BOOST_CONSTEXPR_OR_CONST std::size_t native_alignment = atomics::detail::alignment_of< lslboost::uint32_t >::value;
...
struct storage_traits< 8u >
{
    ...
    static BOOST_CONSTEXPR_OR_CONST std::size_t native_alignment = atomics::detail::alignment_of< lslboost::uint64_t >::value;
...
struct storage_traits< 16u >
{
    ...
    static BOOST_CONSTEXPR_OR_CONST std::size_t native_alignment = atomics::detail::alignment_of< lslboost::uint128_type >::value;
    static BOOST_CONSTEXPR_OR_CONST std::size_t alignment = 16u;
};

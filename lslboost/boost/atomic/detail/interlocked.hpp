...
#define BOOST_ATOMIC_INTERLOCKED_INCREMENT(dest) lslboost::atomics::detail::InterlockedIncrement((long*)(dest))
#define BOOST_ATOMIC_INTERLOCKED_DECREMENT(dest) lslboost::atomics::detail::InterlockedDecrement((long*)(dest))

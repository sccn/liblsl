...
#define BOOST_ATOMIC_DETAIL_ALIGNED_VAR(var_alignment, var_type, var_name) \
    ...
    { \
        var_type var_name; \
        lslboost::type_with_alignment< var_alignment >::type BOOST_JOIN(var_name, _aligner); \
    }
...
#define BOOST_ATOMIC_DETAIL_ALIGNED_VAR_TPL(var_alignment, var_type, var_name) \
    ...
    { \
        var_type var_name; \
        typename lslboost::type_with_alignment< var_alignment >::type BOOST_JOIN(var_name, _aligner); \
    }

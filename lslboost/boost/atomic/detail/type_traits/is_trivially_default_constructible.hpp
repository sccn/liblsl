...
template< typename T >
using is_trivially_default_constructible = lslboost::has_trivial_constructor< T >;
#else
template< typename T >
struct is_trivially_default_constructible : public lslboost::has_trivial_constructor< T > {};
#endif

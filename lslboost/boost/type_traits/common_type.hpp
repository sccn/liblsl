...
{
   BOOST_STATIC_ASSERT_MSG(::lslboost::is_complete<T>::value || ::lslboost::is_void<T>::value || ::lslboost::is_array<T>::value, "Arguments to common_type must both be complete types");
};
...
{
   BOOST_STATIC_ASSERT_MSG(::lslboost::is_complete<T1>::value || ::lslboost::is_void<T1>::value || ::lslboost::is_array<T1>::value, "Arguments to common_type must both be complete types");
   BOOST_STATIC_ASSERT_MSG(::lslboost::is_complete<T2>::value || ::lslboost::is_void<T2>::value || ::lslboost::is_array<T2>::value, "Arguments to common_type must both be complete types");
};

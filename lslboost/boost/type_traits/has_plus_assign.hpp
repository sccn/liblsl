...
namespace lslboost
{
   ...
   namespace binary_op_detail {
      ...
      struct has_plus_assign_ret_imp<T, U, Ret, lslboost::void_t<decltype(std::declval<typename add_reference<T>::type>() += std::declval<typename add_reference<U>::type>())> >
      ...
      struct has_plus_assign_void_imp<T, U, lslboost::void_t<decltype(std::declval<typename add_reference<T>::type>() += std::declval<typename add_reference<U>::type>())> >
      ...
      template <class T, class U>
      struct has_plus_assign_dc_imp<T, U, lslboost::void_t<decltype(std::declval<typename add_reference<T>::type>() += std::declval<typename add_reference<U>::type>())> >

...
{
   BOOST_STATIC_ASSERT_MSG(lslboost::is_complete<To>::value || lslboost::is_void<To>::value || lslboost::is_array<To>::value, "Destination argument type to is_convertible must be a complete type");
   BOOST_STATIC_ASSERT_MSG(lslboost::is_complete<From>::value || lslboost::is_void<From>::value || lslboost::is_array<From>::value, "From argument type to is_convertible must be a complete type");
};
...
struct is_convertible : public integral_constant<bool, BOOST_IS_CONVERTIBLE(From, To)> 
{
   ...
   BOOST_STATIC_ASSERT_MSG(lslboost::is_complete<From>::value || lslboost::is_void<From>::value || lslboost::is_array<From>::value || lslboost::is_reference<From>::value, "From argument type to is_convertible must be a complete type");
#endif

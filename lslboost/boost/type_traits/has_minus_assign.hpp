...
namespace lslboost
{
   ...
   namespace binary_op_detail {
      ...
      template <class T, class U, class Ret>
      struct has_minus_assign_ret_filter : public lslboost::binary_op_detail::has_minus_assign_ret_imp <T, U, Ret> {};
      template <class T, class U>
      struct has_minus_assign_ret_filter<T, U, void> : public lslboost::binary_op_detail::has_minus_assign_void_imp <T, U> {};
      template <class T, class U>
      struct has_minus_assign_ret_filter<T, U, lslboost::binary_op_detail::dont_care> : public lslboost::binary_op_detail::has_minus_assign_dc_imp <T, U> {};

      template <class T, class U, class Ret, bool b>
      struct has_minus_assign_void_ptr_filter : public lslboost::binary_op_detail::has_minus_assign_ret_filter <T, U, Ret> {};
      template <class T, class U, class Ret>
      struct has_minus_assign_void_ptr_filter<T, U, Ret, true> : public lslboost::false_type {};

   }

   template <class T, class U = T, class Ret = lslboost::binary_op_detail::dont_care>
   struct has_minus_assign :
      public lslboost::binary_op_detail::has_minus_assign_void_ptr_filter<
      T, U, Ret,
      ...
      || (lslboost::is_pointer<typename remove_reference<T>::type>::value && lslboost::is_pointer<typename remove_reference<U>::type>::value)> {};

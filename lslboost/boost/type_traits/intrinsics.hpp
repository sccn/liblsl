...
#       define BOOST_HAS_TRIVIAL_MOVE_CONSTRUCTOR(T) ((__is_trivially_constructible(T, T&&) || lslboost::is_pod<T>::value) && ! ::lslboost::is_volatile<T>::value && ! ::lslboost::is_reference<T>::value)
#       define BOOST_HAS_TRIVIAL_MOVE_ASSIGN(T) ((__is_trivially_assignable(T, T&&) || lslboost::is_pod<T>::value) && ! ::lslboost::is_const<T>::value && !::lslboost::is_volatile<T>::value && ! ::lslboost::is_reference<T>::value)

...
namespace lslboost
{
   ...
   struct BOOST_TT_TRAIT_NAME : public lslboost::binary_op_detail:: BOOST_JOIN(BOOST_TT_TRAIT_NAME, _ret_imp) <T, U, Ret> {};
   template <class T, class U>
   struct BOOST_TT_TRAIT_NAME<T, U, void> : public lslboost::binary_op_detail:: BOOST_JOIN(BOOST_TT_TRAIT_NAME, _void_imp) <T, U> {};
   template <class T, class U>
   struct BOOST_TT_TRAIT_NAME<T, U, lslboost::binary_op_detail::dont_care> : public lslboost::binary_op_detail:: BOOST_JOIN(BOOST_TT_TRAIT_NAME, _dc_imp) <T, U> {};

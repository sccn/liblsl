...
public:
    ...
    template <typename U>
    runtime_sized_ringbuffer(typename lslboost::allocator_rebind<Alloc, U>::type const & alloc, size_type max_elements):
...
public:
     ...
     */
    template <typename U>
    explicit spsc_queue(typename lslboost::allocator_rebind<allocator, U>::type const &)
    {
     ...
     */
    template <typename U>
    spsc_queue(size_type element_count, typename lslboost::allocator_rebind<allocator, U>::type const & alloc):

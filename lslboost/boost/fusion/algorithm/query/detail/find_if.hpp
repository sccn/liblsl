...
namespace lslboost { namespace fusion { namespace detail
{
    ...
    struct static_find_if
    {
        ...
        template <typename Iterator>
        BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED
        static typename lslboost::disable_if<traits::is_random_access<Iterator>, type>::type
        ...
        template <typename Iterator>
        BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED
        static typename lslboost::enable_if<traits::is_random_access<Iterator>, type>::type
        iter_call(Iterator const& iter)
        {

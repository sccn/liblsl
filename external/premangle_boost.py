...
redirect_headers = [
    ...
    'cstdint.hpp',
    'date_time/posix_time/posix_time_duration.hpp',
    'detail/endian.hpp',
    ...
    'thread/lock_guard.hpp',
    'thread/mutex.hpp',
    'thread/once.hpp',
    'thread/recursive_mutex.hpp',
    'thread/shared_mutex.hpp',
    'thread/thread_only.hpp',
